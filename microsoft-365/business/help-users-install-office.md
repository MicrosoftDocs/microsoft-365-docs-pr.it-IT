...
2. Andare a **installazione** nel riquadro di spostamento a sinistra e nella pagina **configurazione** , scorrere fino a **Apps and Updates**.
    > [!NOTE]
    > La scheda potrebbe non essere visualizzata se tutti gli utenti hanno installato le app di Office.
  
3. Nella **Guida degli utenti installare la propria scheda app di Office** , scegliere **Visualizza**e **quindi iniziare**.
