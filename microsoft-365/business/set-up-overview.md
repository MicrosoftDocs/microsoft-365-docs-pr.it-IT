...
## <a name="step-2-set-up-security-policies-and-configure-devices"></a>Passaggio 2: impostare i criteri di sicurezza e configurare i dispositivi 
  ...
  - Utilizzare il [programma di installazione guidata](set-up.md#protect-your-organization) per configurare i criteri per i dispositivi. 
...
Vedere anche [i primi 10 modi per proteggere il premio Microsoft 365 business](https://docs.microsoft.com/office365/admin/security-and-compliance/secure-your-business-data) per una mappa stradale delle migliori procedure di sicurezza.

## <a name="step-3-set-up-and-manage-windows-10-devices"></a>Passaggio 3: configurare e gestire i dispositivi Windows 10

Dopo aver completato l'installazione guidata, è necessario proteggere tutti i computer Windows 10 nell'organizzazione.
