---
title: Come eseguire il mapping delle funzionalità di Microsoft 365 Business Premium alle impostazioni di Intune
f1.keywords:
- NOCSH
ms.author: sharik
author: skjerland
...
description: Informazioni su come le funzionalità di protezione Microsoft 365 Business Premium mappare alle impostazioni di Intune. La sottoscrizione fornisce una licenza per modificare le impostazioni di Intune.
...
---
# <a name="how-do-protection-features-in-microsoft-365-business-premium-map-to-intune-settings"></a>Come eseguire il mapping delle funzionalità di Microsoft 365 Business Premium alle impostazioni di Intune
...
Per trovare l'impostazione di Intune, accedere con le credenziali Microsoft 365 Business Premium amministratore e passare a **Admin center** e quindi **a Intune**.
  
 > [!IMPORTANT]
 > 
 > Una Microsoft 365 Business Premium consente di modificare tutte le impostazioni di Intune. Vedi [Introduzione a Intune per iniziare.](/intune/introduction-intune)
...
|Richiedi agli utenti di accedere di nuovo dopo Office app inattive per (questa opzione è disabilitata se il PIN non è necessario)  <br/> | Controlla di nuovo i requisiti di accesso dopo (minuti)  <br/>  Viene impostato anche:  <br/> **Timeout** è impostato su minuti  <br/>  Si tratta dello stesso numero di minuti impostato in Microsoft 365 Business.  <br/> **Periodo di prova offline** è impostato su 720 minuti per impostazione predefinita  <br/> |
...
Per trovare l'impostazione di Intune, accedere con le credenziali Microsoft 365 Business Premium amministratore e passare al [portale di Azure.](https://portal.azure.com) Selezionare **Altri servizi** e digitare Intune nel **filtro**. Selezionare **Intune App Protection** App \> **Policy**.
  
 > [!IMPORTANT]
 >
 >Una Microsoft 365 Business Premium consente di modificare solo le impostazioni di Intune mappate alle impostazioni disponibili in Microsoft 365 Business Premium. 
...
|Impedire agli utenti di copiare i dati aziendali nei file personali.  <br/> |**Impostazioni obbligatorie** \> **Modalità di Windows Information Protection**. **On** in Microsoft 365 Business Premium mappa a: **Hide Overrides,** **Off** in Microsoft 365 Business Premium maps to: **Off**.  <br/> |
...
|Consenti agli utenti di ricevere da Microsoft suggerimenti e pubblicità su Windows  <br/> |**Windows riflettori**, tutti bloccati se questa opzione è **disattivata** in Microsoft 365 Business Premium.  <br/> |
|Mantieni automaticamente aggiornati i dispositivi Windows 10  <br/> | Questa impostazione è in **Microsoft Intune** \> **Service updates - Windows 10 Update Rings,** scegliere **Update policy for Windows 10 devices** e quindi **Properties** \> **Impostazioni**.  <br/>  Quando l Microsoft 365 Business Premium è impostata su **On,** vengono impostate tutte le impostazioni seguenti:  <br/> **Service branch** is set to **CB** (CBB when this is turned off in Microsoft 365 Business Premium).  <br/> **Aggiornamenti ai prodotti Microsoft** è impostato su **Consenti**.  <br/> **Driver di Windows** è impostato su **Consenti**.  <br/> **Comportamento di aggiornamento automatico** è impostato su **Installa automaticamente durante la manutenzione** con:  <br/> **Inizio dell'orario di attività** è impostato su **6**.  <br/> **Fine dell'orario di attività** è impostato su **22**.  <br/> **Periodo di differimento dell'aggiornamento qualitativo (giorni)** è impostato su **0**.  <br/> **Periodo di differimento dell'aggiornamento delle funzionalità (giorni)** è impostato su **0**.  <br/> **Modalità di download con ottimizzazione recapito** è impostato su **HTTP combinato con peering dietro la stessa NAT**.  <br/> |
|||
