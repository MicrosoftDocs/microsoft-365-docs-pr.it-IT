...
Per trovare l'impostazione Intune, accedere con le credenziali di amministratore di Microsoft 365 Business Premium e accedere a interfaccia di **Amministrazione**e quindi **Intune**.
...
Per trovare l'impostazione Intune, accedere con le credenziali di amministratore di Microsoft 365 Business Premium e passare a [portale di Azure](https://portal.azure.com). Selezionare **altri servizi**e digitare Intune nel **filtro**. Selezionare **Intune App Protection** \> **criteri app**di protezione delle app di Intune.
  
 > [!IMPORTANT]
 >
 >Un abbonamento a Microsoft 365 Business Premium fornisce una licenza per modificare solo le impostazioni di Intune che corrispondono alle impostazioni disponibili in Microsoft 365 Business Premium. 
