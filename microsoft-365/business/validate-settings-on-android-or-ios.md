...
3. Scegliere **Reimposta PIN**. Verrà richiesto di eseguire l'accesso con le credenziali di Microsoft 365 Business Premium dell'utente e quindi di impostare un nuovo PIN.
...
3. Scegliere **OK**. Verrà richiesto di eseguire l'accesso con le credenziali di Microsoft 365 Business Premium dell'utente e quindi di impostare un nuovo PIN.
...
3. Dovrebbe essere visualizzata solo un'opzione per OneDrive for Business. In caso contrario, toccare **Aggiungi account** e selezionare **OneDrive for business** dalla schermata **Aggiungi account di archiviazione** . Fornire all'utente finale Microsoft 365 Business Premium per eseguire l'accesso quando richiesto. 
