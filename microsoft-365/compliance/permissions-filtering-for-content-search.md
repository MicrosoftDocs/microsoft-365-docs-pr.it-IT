...
Questo esempio consente ai membri del gruppo di ruoli eDiscovery Manager di eseguire ricerche solo nelle cassette postali dei membri del gruppo di distribuzione Ottawa Users. Il cmdlet Get-DistributionGroup in Exchange Online PowerShell viene utilizzato per trovare i membri del gruppo Ottawa Users.
...
In questo esempio si impedisce agli utenti di eliminare il contenuto dalle cassette postali dei membri del gruppo di distribuzione Team esecutivo. Il cmdlet Get-DistributionGroup in Exchange Online PowerShell viene utilizzato per trovare i membri del gruppo di team Executive.
