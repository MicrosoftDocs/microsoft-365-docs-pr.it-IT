...
Utilizzare un connettore Globanet nel Centro conformità Microsoft 365 per importare e archiviare i dati dalla piattaforma Reuters FX alle cassette postali degli utenti nell'organizzazione di Microsoft 365. Globanet fornisce un connettore [FX Reuters](https://globanet.com/reuters-fx/) configurato per acquisire elementi dall'origine dati di terze parti (a intervalli regolari) e quindi importare tali elementi in Microsoft 365. Il connettore converte le valute e i tassi di cambio dall'account FX di Reuters in un formato di messaggio di posta elettronica e quindi importa tali elementi nella cassetta postale dell'utente in Microsoft 365.
...
3. Il connettore FX Reuters creato nel Centro conformità Microsoft 365, si connette ogni giorno al sito Globanet Merge1 e trasferisce il contenuto in una posizione sicura di Archiviazione di Azure nel cloud Microsoft.
...
## <a name="step-2-configure-the-reuters-fx-connector-on-the-globanet-merge1-site"></a>Passaggio 2: Configurare il connettore FX reuters nel sito Globanet Merge1

Il secondo passaggio consiste nel configurare il connettore FX Reuters nel sito Globanet Merge1. Per informazioni sulla configurazione del connettore FX di Reuters, vedere [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Reuters%20FX%20User%20Guide%20.pdf).
