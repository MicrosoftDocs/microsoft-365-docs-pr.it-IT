...
- [Cercare ed eliminare i messaggi di posta elettronica](search-for-and-delete-messages-in-your-organization.md) , ad esempio i messaggi che il contenuto di un virus, allegati pericolosi o messaggi di phishing
...
- [Eseguire la ricerca di cassette postali e cartelle del sito specifiche](use-content-search-for-targeted-collections.md) (denominate * insieme mirato) quando si è certi che gli elementi sensibili a un caso siano presenti in tale cartella
