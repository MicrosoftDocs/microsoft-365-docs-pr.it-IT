...
|(nessuno)|CaseViewed|Get-ComplianceCase|Un utente ha visualizzato l'elenco dei casi nella pagina **Core eDiscovery** nel Centro conformità o eseguendo il cmdlet Get-ComplianceCase.|
