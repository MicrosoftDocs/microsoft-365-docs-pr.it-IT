...
## <a name="encryption-for-data-at-rest-and-data-in-transit"></a>Crittografia dei dati in pausa e dei dati in transito
  ...
  Esempi di dati in pausa includono i file caricati in una raccolta di SharePoint, i dati di Project Online, i documenti caricati in una riunione Skype for Business, i messaggi di posta elettronica e gli allegati archiviati nelle cartelle nella cassetta postale e i file caricati in OneDrive for Business.
...
|Chat, messaggi e file in transito tra destinatari tramite Microsoft Teams. <br/> |Teams usa TLS e MTLS per crittografare i messaggi istantanei. Il traffico multimediale viene crittografato tramite Secure RTP (SRTP). Teams utilizza algoritmi conformi a FIPS (Federal Information Processing Standard) per gli scambi di chiavi di crittografia. <br/> |[Crittografia per Teams](/microsoftteams/teams-security-guide#encryption-for-teams) <br/> |
...
[10 modi principali per proteggere i piani di Microsoft 365 per le aziende](/office365/admin/security-and-compliance/secure-your-business-data)
