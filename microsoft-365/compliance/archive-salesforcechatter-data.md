...
---
# <a name="set-up-a-connector-to-archive-salesforce-chatter-data"></a>Configurare un connettore per l'archiviazione dei dati relativi alle chiacchiere Salesforce
