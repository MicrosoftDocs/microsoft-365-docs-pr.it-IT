...
- **Avviso di pubblicazione** -questo è il primo avviso inviato al custode. Questo conterrà le istruzioni di rilascio e l'avviso di blocco accodato alla fine del messaggio.
...
- **Avviso di ristampa** -nel corso di un'indagine, se il contenuto dell'avviso di blocco viene aggiornato, l'avviso aggiornato verrà inviato automaticamente al custode.
