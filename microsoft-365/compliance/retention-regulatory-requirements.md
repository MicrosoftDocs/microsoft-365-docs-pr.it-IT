...
- FINRA (Financial Industry Regulatory Authority) Rule 4511 (c), che rimanda ai requisiti di formato ed elementi multimediali della SEC Rule 17a-4 (f).  

- I requisiti dei record elettronici basati su principi della CFTC (Commodity Futures Trading Commission) in 17 CFR § 1.31 (c)-(d).

Secondo l'opinione di Cohasset quando le funzionalità di conformità sono configurate correttamente e sono applicate e gestite con attenzione come descritto nel report, i servizi Microsoft 365 valutati soddisfano i cinque requisiti correlati alla registrazione e all'archiviazione non riscrivibile e non cancellabile dei record elettronici.
