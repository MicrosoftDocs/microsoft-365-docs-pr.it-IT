...
2. Una volta ogni 24 ore, gli elementi degli account FX Connect vengono copiati nel sito Globanet Merge1. Il connettore converte inoltre gli elementi fx Connect in un formato di messaggio di posta elettronica.

3. Il connettore FX Connect creato nel Centro conformità Microsoft 365, si connette al sito Globanet Merge1 ogni giorno e trasferisce gli elementi fx Connect in una posizione sicura di Archiviazione di Azure nel cloud Microsoft.
...
2. Nella pagina **di descrizione del prodotto FX Connect** fare clic su Aggiungi **connettore.**
...
2. Fare clic **sulla scheda Connettori,** quindi selezionare il connettore **FX Connect** per visualizzare la pagina a comparsa. Questa pagina contiene le proprietà e le informazioni sul connettore.
