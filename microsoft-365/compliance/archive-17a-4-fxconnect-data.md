...
Nella panoramica seguente viene illustrato il processo di utilizzo di un connettore dati per archiviare i dati Connessione in Microsoft 365.

![Flusso di lavoro di archiviazione per i Connessione fx da 17a a 4](../media/FXConnectDataParserConnectorWorkflow.png)

1. L'organizzazione collabora con 17a-4 per configurare l'Connessione DataParser.

2. A intervalli regolari, gli Connessione fx vengono raccolti da DataParser. DataParser converte anche il contenuto di un messaggio in un formato di messaggio di posta elettronica.

3. Il connettore Fx Connessione DataParser creato nel Centro conformità Microsoft 365 si connette a DataParser e trasferisce i messaggi in una posizione Archiviazione di Azure sicura nel cloud Microsoft.

4. Una sottocartella nella cartella Posta in arrivo denominata **FX Connessione DataParser** viene creata nelle cassette postali degli utenti e gli elementi Connessione fx vengono importati in tale cartella. Il connettore determina in quale cassetta postale importare gli elementi utilizzando il valore della *proprietà Email.* Ogni elemento Connessione fx contiene questa proprietà, che viene popolata con l'indirizzo di posta elettronica di ogni partecipante.
...
1. Passare a <https://compliance.microsoft.com> e quindi fare clic su **Connettori dati** FX Connessione  >  **DataParser**.

2. Nella pagina fx Connessione descrizione del prodotto **DataParser** fare clic **su Aggiungi connettore**.

3. Nella pagina **Condizioni di servizio** fare clic su **Accetta.**

4. Immettere un nome univoco che identifichi il connettore e quindi fare clic su **Avanti.**

5. Accedi al tuo account 17a-4 e completa i passaggi della procedura guidata di connessione fx Connessione DataParser.

## <a name="step-2-configure-the-fx-connect-dataparser-connector"></a>Passaggio 2: Configurare il connettore FX Connessione DataParser

Utilizzare il supporto 17a-4 per configurare il connettore FX Connessione DataParser.

## <a name="step-3-map-users"></a>Passaggio 3: mappare gli utenti

Il connettore Fx Connessione DataParser mappa automaticamente gli utenti ai propri Microsoft 365 di posta elettronica prima di importare i dati in Microsoft 365.

## <a name="step-4-monitor-the-fx-connect-dataparser-connector"></a>Passaggio 4: Monitorare il connettore FX Connessione DataParser

Dopo aver creato un connettore Fx Connessione DataParser, è possibile visualizzare lo stato del connettore nel Centro conformità Microsoft 365.

1. Vai a <https://compliance.microsoft.com> e fai clic su **Connettori dati** nel riquadro di spostamento sinistro.

2. Fare clic **sulla** scheda Connettori e quindi selezionare il connettore FX Connessione DataParser creato per visualizzare la pagina a comparsa, contenente le proprietà e le informazioni sul connettore.
