...
Al momento, è necessario utilizzare AzCopy v8.1 per caricare dati non Microsoft 365 in Advanced eDiscovery. Se non si utilizza AzCopy  v8.1, il comando AzCopy visualizzato nella pagina dei file Upload mostrata nella schermata precedente restituisce un errore. Per installare questa versione, vedere [Trasferire dati con AzCopy v8.1 in Windows](/previous-versions/azure/storage/storage-use-azcopy).
