...
Sono disponibili ulteriori informazioni su Servizi professionali di Microsoft qui (<https://www.microsoft.com/microsoftservices/professional_services.aspx>) e accedendo alla sezione Servizi professionali di Microsoft nel Centro protezione Microsoft (<https://www.microsoft.com/trustcenter/cloudservices/commercialsupport>). Servizi professionali di Microsoft tiene seriamente conto degli obblighi derivanti dal Regolamento generale sulla protezione dei dati (RGPD). Le informazioni riportate in questo documento hanno lo scopo di rispondere alle domande dei clienti sul modo in cui le offerte di consulenza e supporto di Microsoft assistono i clienti nell'adempimento agli obblighi definiti dall'RGPD in merito alla risposta alle richieste DSR (Data Subject Rights, Diritti del soggetto dei dati).<span id="_Toc508792502" class="anchor"><span id="_Toc510704608" class="anchor"></span></span>
...
#### <a name="overview-of-the-processes-outlined-in-this-guide"></a>Panoramica dei processi descritti in questa guida
  ...
  ***Scoprire.*** Trovare i dati personali che potrebbero essere oggetto di una richiesta DSR. Dopo aver raccolto dei materiali potenzialmente reattivi, eseguire una o più delle azioni DSR descritte nella seguente procedura per rispondere alla richiesta DSR. In alternativa, determinare se la richiesta non soddisfa le linee guida dell'organizzazione relative alla risposta alle richieste DSR.

  ***Accedere.*** Recuperare i dati personali che risiedono nel cloud Microsoft e, se richiesto, fare una copia di tali dati disponibile per l'interessato.

  ***Rettificare.*** Apportare delle modifiche o implementare altre azioni richieste per i dati personali.

  ***Limitare.*** Limitare il trattamento dei dati personali interrompendo l'attività in un impegno.

  ***Eliminare.*** Rimuovere in modo definitivo i dati personali che risiedono nei sistemi IT di Microsoft.

  ***Esportare.*** Fornire una copia dei dati personali al cliente o agli interessati.
...
Spiegazione di come Microsoft risponde alle richieste dai dipendenti di un cliente o altri interessati per esercitare i propri diritti.
...
## <a name="dsr-for-customer-provided-data-consulting-services-including-fasttrack-migration-services"></a>DSR per i dati forniti dal cliente: servizi di consulenza tra cui i servizi di migrazione di FastTrack 
...
Per gli impegni di Microsoft Consulting Services contratti in cui si applica Microsoft Professional Services Data Protection Addendum (<http://aka.ms/professionalservicesdpa>).

Microsoft è il titolare del trattamento dei dati per i contatti cliente che lavorano con il team che si occupa degli impegni. Questi soggetti devono contattare il [supporto Microsoft per la privacy](http://go.microsoft.com/fwlink/?LinkId=321116) per soddisfare i diritti degli interessati.
