...
|Numero massimo di posizioni in una ricerca di contenuto da cui è possibile esportare gli elementi. Se la ricerca di contenuto che si sta esportando ha più posizioni rispetto a questo limite, l'esportazione avrà esito negativo. Per ulteriori informazioni, vedere [Export content search results](export-search-results.md).  <br/> |100.000  <br/> |
