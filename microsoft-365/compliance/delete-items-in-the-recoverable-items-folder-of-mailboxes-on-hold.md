...
Dopo aver identificato i criteri di conservazione a livello dell'organizzazione, passare alla pagina **conservazione** delle **informazioni** \> sulla sicurezza nel centro protezione & conformità, modificare ogni criterio di conservazione a livello di organizzazione identificato nel passaggio precedente e aggiungere la cassetta postale all'elenco dei destinatari esclusi. In questo modo, la cassetta postale dell'utente verrà rimossa dal criterio di conservazione. 
