...
Utilizzare un connettore Globanet nel Centro conformità Microsoft 365 per importare e archiviare i dati dalla piattaforma Reuters Eikon alle cassette postali degli utenti nell'organizzazione di Microsoft 365. Globanet fornisce un connettore [Reuters Eikon](https://globanet.com/eikon/) configurato per acquisire elementi dall'origine dati di terze parti (regolarmente) e importare tali elementi in Microsoft 365. Il connettore converte il contenuto, ad esempio messaggi da persona a persona, chat di gruppo, allegati e dichiarazioni di non responsabilità dall'account Reuters Eikon di un utente in un formato di messaggio di posta elettronica e quindi importa tali elementi nella cassetta postale dell'utente in Microsoft 365.
...
2. Una volta ogni 24 ore, gli elementi di Reuters Eikon vengono copiati nel sito Globanet Merge1. Il connettore converte anche gli elementi di Reuters Eikon in un formato di messaggio di posta elettronica.
...
Il secondo passaggio consiste nel configurare il connettore Reuters Eikon nel sito Merge1. Per informazioni su come configurare il connettore Reuters Eikon nel sito Globanet Merge1, vedere [Merge1 Third-Party Connectors User Guide.](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Reuters%20Eikon%20User%20Guide%20.pdf)
