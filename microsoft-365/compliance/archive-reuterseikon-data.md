...
Usare un connettore Globanet nel Centro conformità Microsoft 365 per importare e archiviare i dati dalla piattaforma Reuters Eikon alle cassette postali degli utenti nell'organizzazione di Microsoft 365. Globanet fornisce un connettore [Reuters Eikon](https://globanet.com/eikon/) configurato per acquisire elementi dall'origine dati di terze parti (su base regolare) e importare tali elementi in Microsoft 365. Il connettore converte il contenuto, ad esempio messaggi da persona a persona, chat di gruppo, allegati e dichiarazioni di non responsabilità dall'account Reuters Eikon di un utente in un formato di messaggio di posta elettronica e quindi importa tali elementi nella cassetta postale dell'utente in Microsoft 365.

Dopo che i dati di Reuters Eikon sono archiviati nelle cassette postali degli utenti, è possibile applicare le funzionalità di conformità di Microsoft 365, ad esempio conservazione per controversia legale, eDiscovery, criteri di conservazione ed etichette di conservazione e conformità delle comunicazioni. L'uso di un connettore Reuters Eikon per importare e archiviare i dati in Microsoft 365 può aiutare l'organizzazione a rimanere conforme ai criteri normativi e governativi.

## <a name="overview-of-archiving-reuters-eikon-data"></a>Panoramica dell'archiviazione dei dati di Reuters Eikon

La seguente panoramica spiega il processo di utilizzo di un connettore per archiviare i dati di Reuters Eikon in Microsoft 365.
...
2. Una volta ogni 24 ore, gli elementi di Reuters Eikon vengono copiati nel sito Globanet Merge1. Il connettore converte inoltre gli elementi di Reuters Eikon in un formato di messaggio di posta elettronica.

3. Il connettore Reuters Eikon creato nel Centro conformità Microsoft 365 si connette ogni giorno al sito Globanet Merge1 e trasferisce il contenuto in una posizione sicura di Archiviazione di Azure nel cloud Microsoft.
...
1. Accedere a [https://compliance.microsoft.com](https://compliance.microsoft.com/) e quindi fare clic su **Connettori dati**  >  **Reuters Eikon.**

2. Nella pagina **di descrizione del prodotto Reuters Eikon,** fare clic **su Aggiungi connettore.**
...
## <a name="step-2-configure-the-reuters-eikon-connector-on-the-globanet-merge1-site"></a>Passaggio 2: Configurare il connettore Reuters Eikon nel sito Globanet Merge1

Il secondo passaggio consiste nel configurare il connettore Reuters Eikon nel sito Merge1. Per informazioni su come configurare il connettore Reuters Eikon nel sito Globanet Merge1, vedere la Guida per l'utente di [Merge1 Third-Party Connectors.](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Reuters%20Eikon%20User%20Guide%20.pdf)
