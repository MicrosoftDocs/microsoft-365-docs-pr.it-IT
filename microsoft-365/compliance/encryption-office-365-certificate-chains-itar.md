...
---
# <a name="microsoft-365-encryption-chains---dod-and-gcc-high"></a>Catene di crittografia di Microsoft 365 - DOD e GCC High

Microsoft 365 sfrutta diversi provider di certificati. Di seguito viene descritto l'elenco completo dei certificati radice di Microsoft 365 noti che i clienti DOD e **GCC High** possono riscontrare quando accedono a Microsoft 365. Per informazioni sui certificati che potrebbe essere necessario installare nella propria infrastruttura, vedere Pianificare certificati SSL di terze parti [per Microsoft 365.](https://docs.microsoft.com/microsoft-365/enterprise/plan-for-third-party-ssl-certificates)

Le seguenti informazioni sul certificato si applicano a tutti i **clienti DOD e GCC High.**

Last updated: **16/10/2020**

>[!NOTE]
>Per informazioni sui certificati applicabili ai clienti **in tutto il mondo,** vedere Catene di crittografia [di Microsoft 365.](encryption-office-365-certificate-chains.md)

| **Tipo di certificato** | **Download P7b** | **Endpoint CRL** | **Endpoint OCSP** |
| --- | --- | --- | --- | --- |
| Certificati radice e intermedi pubblicamente attendibili | [Bundle di certificati ITAR di Microsoft 365 (P7B)](https://download.microsoft.com/download/b/3/a/b3ae08a2-516c-46a9-8723-6256e4fd6383/m365_chain_certs_itar20201012.p7b) | crl.entrust.net<br>crl3.digicert.com<br>crl4.digicert.com | ocsp.digicert.com<br>ocsp.entrust.net |

Espandere le sezioni radice e intermedie seguenti per visualizzare ulteriori dettagli sui provider di certificati.

## <a name="microsoft-365-certificate-details"></a>**Dettagli certificato di Microsoft 365**
...
| **Lunghezza chiave pubblica** | BIT RSA 2048 |
| **Algoritmo di firma** | sha256RSA |
...
| **Lunghezza chiave pubblica** | BIT RSA 2048 |
| **Algoritmo di firma** | sha256RSA |
| **Validità non prima** | Venerdì 8 marzo 2013 4.00 |
| **Validità non fino a quando** | Mercoledì 8 marzo 2023 4.00 |
...
| **Validità non dopo** | 11 novembre 02.51.17 UTC |
...
| --- | --- |
| **Autorità di certificazione** | CN=Entrust Root Certification Authority - G2<br>OU= &quot; (c) 2009 Entrust, Inc. - solo per uso autorizzato&quot;<br>OU=See www.entrust.net/legal-terms<br>O= &quot; Entrust, Inc.&quot;<br>C=US |
| **Numero di serie** | 61:A1:E7:D2:00:00:00:00:51:D3:66:A6 |
| **Lunghezza chiave pubblica** | RSA 2048 bit (e 65537) |
| **Algoritmo di firma** | sha256RSA |
| **Validità non prima** | Dic 15 07:25:03 2014 UTC |
| **Validità non dopo** | Ott 15 08:55:03 2030 UTC |
