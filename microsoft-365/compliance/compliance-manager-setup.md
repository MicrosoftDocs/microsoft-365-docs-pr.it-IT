...
2. Selezionare **Compliance Manager** nel riquadro di spostamento a sinistra. Si arriva al [Dashboard Compliance Manager](#understand-the-compliance-manager-dashboard).
