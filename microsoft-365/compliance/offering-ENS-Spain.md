...
ms.locfileid: "39233649"
---
# <a name="compliance-offering-spain-esquema-nacional-de-seguridad-ens-high-level-security-measures"></a>Offerta di conformità: misure di sicurezza di alto livello dell'Esquema Nacional de Seguridad (ENS) spagnolo
...
- [Informe Auditoria ENS per Azure (spagnolo)](https://aka.ms/AzureInformeAuditoriaENS)
- [Certificado ENS di Azure (spagnolo)](https://aka.ms/AzureNationalSecurityFrameworkCertificadoENS)
...
- [Informe Auditoria ENS per Office 365 (spagnolo)](https://aka.ms/Office365InformeAuditoriaENS)
- [Certificado ENS di Office 365 (spagnolo)](https://aka.ms/Office365NationalSecurityFrameworkCertificadoENS)
...
È necessario il documento di informazioni di base sull'offerta? Scarica il [PDF](https://download.microsoft.com/download/2/3/2/23208181-BA86-4011-8B4A-3CA7E8E383A1/ENS-Spain-Compliance.pdf).
