---
title: Creare e pubblicare le etichette di riservatezza
ms.author: cabailey
author: cabailey
manager: laurawi
ms.date: ''
...
ms.locfileid: "41233862"
---
# <a name="create-and-configure-sensitivity-labels-and-their-policies"></a>Creare e configurare le etichette di riservatezza e i relativi criteri
...
3. Seguire le indicazioni per le impostazioni dell’etichetta.
    ...
    Per altre informazioni sulle impostazioni delle etichette, vedere [Operazioni eseguibili dalle etichette di riservatezza](sensitivity-labels.md#what-sensitivity-labels-can-do) nelle informazioni generali.
...
5. Una volta create tutte le etichette desiderate, rivedere l'ordine e, se necessario, spostarle verso l'alto o verso il basso. Per modificare l'ordine di un'etichetta selezionare **...** per **Altre azioni**, quindi selezionare **Sposta su** o **Sposta giù**. Per altre informazioni, vedere [Priorità dell’etichetta (l’ordine è importante)](sensitivity-labels.md#label-priority-order-matters) nelle informazioni generali.

Per modificare un'etichetta esistente, selezionarla e quindi scegliere **Modifica etichetta**. Verrà avviata la procedura guidata **Modifica etichetta di riservatezza**, che consente di modificare tutte le impostazioni dell’etichetta descritte al passaggio 3. Se l'etichetta è già pubblicata con un criterio di etichetta, non sono necessarie altre operazioni, ma è possibile che la replica delle modifiche agli utenti e ai percorsi richieda fino a 24 ore.
