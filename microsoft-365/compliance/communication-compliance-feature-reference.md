...
Le comunicazioni vengono analizzate ogni 24 ore dal momento in cui vengono creati i criteri temporali. Ad esempio, se si crea un criterio di lingua offensivo alle 11:00 di mattina, il criterio raccoglierà i segnali di conformità della comunicazione ogni 24 ore alle 11:00 del giorno. La modifica di un criterio non cambia questa volta. Per visualizzare la data e l'ora dell'ultima analisi per un criterio, passare all' *ultima colonna analisi criteri* della pagina **criteri** .
