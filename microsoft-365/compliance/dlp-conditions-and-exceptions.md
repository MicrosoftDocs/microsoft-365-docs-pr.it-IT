...
|condizione o eccezione in DLP|parametri di condizione/eccezione in Microsoft 365 PowerShell|tipo di proprietà|descrizione|
|---|---|---|---|
...
|L'indirizzo del mittente corrisponde ai criteri|condition: *FromAddressMatchesPatterns* <br/> eccezione: *ExceptFromAddressMatchesPatterns*|Modelli|Messaggi in cui l'indirizzo e-mail del mittente contiene modelli di testo che corrispondono alle espressioni regolari specificate.|
...
|Il soggetto corrisponde ai criteri|condition: *SubjectMatchesPatterns* <br/> exception: *ExceptIf SubjectMatchesPatterns*|Modelli|Messaggi in cui il campo Subject contiene modelli di testo che corrispondono alle espressioni regolari specificate.|
...
|L'intestazione corrisponde ai criteri|condition: *HeaderMatchesPatterns* <br/> eccezione: *ExceptIfHeaderMatchesPatterns*|Hash Table|Messaggi che contengono il campo di intestazione specificato e il valore di tale campo di intestazione contiene le espressioni regolari specificate.|
...
|azione in DLP|parametri azione in Microsoft 365 PowerShell|tipo di proprietà|descrizione|
|---|---|---|---|
