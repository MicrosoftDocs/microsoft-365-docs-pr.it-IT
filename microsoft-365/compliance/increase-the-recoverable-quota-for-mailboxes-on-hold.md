...
- **Creare un criterio di conservazione di Exchange personalizzato per le cassette postali in blocco.** Oltre a consentire l'archiviazione delle cassette postali di archiviazione e l'espansione automatica per le cassetta postale sul blocco per controversia legale o In-Place blocco, potrebbe essere necessario creare un criterio di conservazione di Exchange personalizzato per le cassette postali in attesa. In questo modo è possibile applicare un criterio di conservazione alle cassette postali in blocco che differiscono dal criterio di gestione record di messaggistica predefinito applicato alle cassette postali che non sono in attesa e consente di applicare i tag di conservazione per le cassette postali in blocco. Questo include la creazione di un nuovo tag di conservazione per la cartella elementi ripristinabili. 
...
[Passaggio 2: creare un nuovo criterio di conservazione di Exchange per le cassette postali in blocco](#step-2-create-a-new-exchange-retention-policy-for-mailboxes-on-hold)

[Passaggio 3: applicare i nuovi criteri di conservazione di Exchange alle cassette postali in blocco](#step-3-apply-the-new-exchange-retention-policy-to-mailboxes-on-hold)
...
## <a name="step-2-create-a-new-exchange-retention-policy-for-mailboxes-on-hold"></a>Passaggio 2: creare un nuovo criterio di conservazione di Exchange per le cassette postali in blocco
...
## <a name="step-3-apply-the-new-exchange-retention-policy-to-mailboxes-on-hold"></a>Passaggio 3: applicare i nuovi criteri di conservazione di Exchange alle cassette postali in blocco
...
1. Accedere alle **Recipients**  >  **cassette postali** destinatari.
...
In questo esempio viene applicato il nuovo criterio di conservazione a tutte le cassette postali dell'organizzazione che si trovano in In-Place blocco.
