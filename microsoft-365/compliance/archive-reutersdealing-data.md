...
Utilizzare un connettore Globanet nel Centro conformità Microsoft 365 per importare e archiviare i dati dalla piattaforma Reuters Dealing alle cassette postali degli utenti nell'organizzazione di Microsoft 365. Globanet fornisce un connettore [reuters dealing](https://globanet.com/reuters-dealing/) configurato per acquisire elementi dall'origine dati di terze parti (regolarmente) e quindi importare tali elementi in Microsoft 365. Il connettore converte le comunicazioni di gestione dall'account Reuters Dealing in un formato di messaggio di posta elettronica e quindi importa tali elementi nella cassetta postale dell'utente in Microsoft 365.
...
2. Una volta ogni 24 ore, gli elementi reuters dealing vengono copiati nel sito Globanet Merge1. Il connettore converte inoltre gli elementi in un formato di messaggio di posta elettronica.
