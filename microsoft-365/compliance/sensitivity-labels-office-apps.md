...
|[Visualizzare l'utilizzo delle etichette con analisi delle etichette](label-analytics.md) e inviare dati per gli amministratori                      | Anteprima: [Canale corrente (anteprima)](https://office.com/insider)            | Anteprima: [Canale corrente (anteprima)](https://office.com/insider)        | In fase di revisione   | In fase di revisione         | Sì <sup>\*</sup>                                                        |
|[Richiedere agli utenti di applicare un'etichetta alla posta elettronica e ai documenti](sensitivity-labels.md#what-label-policies-can-do)   | Anteprima: distribuzione al [Canale corrente (anteprima)](https://office.com/insider)             | Anteprima: distribuzione al [Canale corrente (anteprima)](https://office.com/insider)         | In fase di revisione   | Anteprima: [Canale beta](https://office.com/insider)         | In fase di revisione                                            
...
|[Visualizzare l'utilizzo delle etichette con analisi delle etichette](label-analytics.md) e inviare dati per gli amministratori                      | Anteprima: [Canale corrente (anteprima)](https://office.com/insider)                       | Anteprima: [Canale corrente (anteprima)](https://office.com/insider)                    | In fase di revisione           | In fase di revisione               | Sì               |
