...
Nella tabella seguente sono elencati i campi dei metadati per i documenti in un set di revisioni in un caso in Advanced eDiscovery. Nella tabella sono disponibili le informazioni seguenti:
...
|Nomi allegati|AttachmentNames|Attachment_Names|Elenco dei nomi degli allegati.|
...
|Data|Data|Data|Date è un campo calcolato che dipende dal tipo di file.<br /><br />Posta elettronica: Data di invio<br />Allegati di posta elettronica: data dell'ultima modifica del documento;se non disponibile, data di invio dell'elemento padre<br />Documenti incorporati: data dell'ultima modifica del documento; se non disponibile, data dell'ultima modifica dell'elemento padre<br />Documenti di SharePoint (include allegati moderni): Data ultima modifica di SharePoint; se non disponibile, la data dell'ultima modifica dei documenti<br />Documenti non di Office 365: data ultima modifica<br />Riunioni: data di inizio della riunione<br />VoiceMail: Data di invio<br />Messaggistica istantanea: data di invio|
...
|Punteggio di pertinenza della famiglia Caso problema 1*||Family_relevance_score_case_issue_1|Punteggio di pertinenza della famiglia Caso numero 1 da Rilevanza.|
...
|Punteggio di pertinenza dei file Caso problema 1*||File_relevance_score_case_issue_1|Punteggio di pertinenza del file Caso problema 1 da Rilevanza.|
...
|Contrassegnato come caso pre tagged problema 1*||Marked_as_pre_tagged_Case_issue_1|Contrassegnato come caso pre tagged numero 1 da Pertinenza.|
|Contrassegnato come seed case issue 1*||Marked_as_seed_Case_issue_1|Contrassegnato come seed Case issue 1 da Relevance.|
...
|Punteggio di pertinenza normalizzato Caso problema 1||Normalized_relevance_score_case_issue_1|Punteggio di pertinenza normalizzato Caso numero 1 da Rilevanza.|
...
|Problema 1 del gruppo di carico di pertinenza||Relevance_load_group_case_issue_1|Gruppo di carico di pertinenza Caso 1 da Pertinenza.|
|Descrizione stato rilevanza Caso 1||Relevance_status_description_Case_issue_1|Descrizione dello stato di pertinenza Caso 1 da Pertinenza.|
|Tag di pertinenza Caso 1||Relevance_tag_case_issue_1|Tag di pertinenza Caso 1 da Rilevanza.|
|Commento per rilevanza||Relevance_comment|Campo commento da Rilevanza.|
...
|Tagged by Case issue 1||Tagged_by_Case_issue_1|Utente che ha taggato questo documento per il caso 1 in Pertinenza.|
...
> [!NOTE]
> Per ulteriori informazioni sulle proprietà disponibili per la ricerca nelle posizioni del contenuto di Office 365 quando si raccolgono dati per un caso advanced eDiscovery, vedere Query con parole chiave e condizioni di ricerca per [Ricerca contenuto.](keyword-queries-and-search-conditions.md)