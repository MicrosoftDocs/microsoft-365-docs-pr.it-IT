...
Le organizzazioni possono creare e aggiungere valutazioni personalizzate più rilevanti per la propria organizzazione. Utilizzare uno dei [modelli preconfigurati](compliance-score.md#templates)del Punteggio di conformità, personalizzare un modello Microsoft con i propri controlli e azioni o creare un modello personalizzato. Leggere i dettagli su come [utilizzare i modelli](working-with-compliance-manager.md#templates).

Informazioni su come il Punteggio di [conformità calcola il Punteggio](compliance-score-methodology.md).
...
È possibile utilizzare uno dei [modelli preconfigurati](compliance-score.md#templates) del Punteggio di conformità per creare valutazioni per determinati standard o [creare un modello personalizzato](working-with-compliance-manager.md#create-a-template).
