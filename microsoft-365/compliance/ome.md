...
Le regole del flusso di posta sono flessibili, consentendo di combinare le condizioni in modo da soddisfare requisiti di sicurezza specifici in una singola regola. Ad esempio, è possibile creare una regola per crittografare tutti i messaggi che contengono parole chiave specificate e indirizzati a destinatari esterni. Le nuove funzionalità per la crittografia dei messaggi di Office 365 crittografano anche le risposte dei destinatari della posta elettronica crittografata.
...
|[Come si apre un messaggio protetto?](https://support.office.com/article/1157a286-8ecc-4b1e-ac43-2a608fbf3098.aspx)|Un utente finale che desidera leggere un messaggio protetto inviato all'utente. In questo articolo sono incluse informazioni sulla lettura dei messaggi in diverse versioni di Outlook e da diversi account di posta elettronica, inclusi gli account esterni a Microsoft 365, ad esempio gmail e Yahoo! account.|
