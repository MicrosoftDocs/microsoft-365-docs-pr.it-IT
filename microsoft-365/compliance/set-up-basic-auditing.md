...
- MOE150
- MET150
description: In questo articolo viene descritto come configurare il controllo di base per iniziare a cercare le attività di controllo eseguite da utenti e amministratori dell'organizzazione.
ms.openlocfilehash: ff1f973226378e5408dfae1d467394a5a5153196
ms.sourcegitcommit: efb932db63ad3ab4af4b585428d567d069410e4e
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 05/11/2021
ms.locfileid: "52314352"
---
# <a name="set-up-basic-auditing-in-microsoft-365"></a>Configurare il controllo di base in Microsoft 365

Il controllo di base in Microsoft 365 consente di cercare i record di controllo per le attività eseguite nei diversi Microsoft 365 da utenti e amministratori. Poiché il controllo di base è abilitato per impostazione predefinita per la maggior parte delle organizzazioni di Microsoft 365 e Office 365, è necessario eseguire solo alcune operazioni prima che l'utente e altri utenti dell'organizzazione possano eseguire ricerche nel log di controllo.

In questo articolo vengono illustrati i passaggi seguenti necessari per configurare il controllo di base.

![Passaggi per configurare il controllo di base](../media/BasicAuditingWorkflow.png)
...
Per ulteriori informazioni, vedere [Controllo di base in Microsoft 365](auditing-solutions-overview.md#basic-auditing).
...
Le licenze per il controllo di base richiedono l'abbonamento all'organizzazione appropriato che fornisce l'accesso a strumento di ricerca log di controllo e alle licenze per utente necessarie per registrare e conservare i record di controllo.
