...
description: Azure e Office 365 consentono alle organizzazioni di scienze naturali di soddisfare i requisiti normativi GxP.
...
ms.locfileid: "39622600"
---
# <a name="compliance-offering-good-clinical-laboratory-and-manufacturing-practices-gxp"></a>Offerte di conformità: buone pratiche cliniche, di laboratorio e di fabbricazione (GxP)

## <a name="about-gxp"></a>Informazioni su GxP

Il termine *GxP* è un’abbreviazione generale per "buona pratica" e si riferisce a linee guida e normative. La "x" indica un particolare settore, clinico (GCP), fabbricazione (GMP), distribuzione (PIL), laboratorio (GLP), agricoltura (GAP) e così via. Non esiste un’unica entità o amministrazione normativa, ogni paese ha le proprie linee guida e autorità di regolamentazione, anche se i requisiti sono simili tra paese a paese. Le normative GxP includono le normative delineate in [US FDA CFR Titolo 21 Parte 11](https://aka.ms/FDA-CFR) e [EudraLex - Volume 4 Buona pratica di fabbricazione (GMP) Linee guida, Allegato 11](https://ec.europa.eu/health/documents/eudralex/vol-4_en) nell'UE.
...
- Microsoft Azure e Microsoft Office 365 sono stati sottoposti a numerosi controlli indipendenti per la gestione della qualità e la sicurezza delle informazioni, tra cui ISO 9001 (QMS) e ISO/IEC 27001 (ISMS). Sono incluse le verifiche periodiche dell’efficacia dei controlli tecnici e procedurali di Microsoft.
...
È necessario il documento di informazioni di base sull'offerta? Scarica il [PDF](https://download.microsoft.com/download/4/5/B/45B4B144-E0D0-432E-A210-B8AF841F9A0A/GXP-Compliance.pdf).
