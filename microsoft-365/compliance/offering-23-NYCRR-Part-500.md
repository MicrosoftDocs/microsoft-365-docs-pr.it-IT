...
- **Designare un Chief Information Security Officer** (CISO) che gestisca il programma di cybersecurity applicando il relativo criterio. Per supportare l'operato del CISO, Microsoft fornisce informazioni di cybersecurity dettagliate riguardo alle distribuzioni cloud di Microsoft attraverso [Azure Defender*](https://azure.microsoft.com/services/security-center/?v=17.23h), [Analisi delle minacce avanzata in Office 365 ](https://docs.microsoft.com/advanced-threat-analytics/) e [Sicurezza di Power BI ](https://go.microsoft.com/fwlink/?LinkId=829185).
