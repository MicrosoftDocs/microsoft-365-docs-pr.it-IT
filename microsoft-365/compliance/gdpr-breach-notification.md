...
ms.locfileid: "34544923"
---
# <a name="breach-notification-under-the-gdpr"></a>Notifica di violazione secondo il GDPR

Per Microsoft la conformità al Regolamento generale sulla protezione dei dati (GDPR) è molto importante. Per informazioni sul modo in cui i servizi Microsoft offrono protezione da una violazione dei dati personali e su come viene gestita un'eventuale violazione, vedere gli argomenti seguenti:
