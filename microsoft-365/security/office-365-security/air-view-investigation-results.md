...
Quando si [verifica un'indagine](office-365-air.md) automatizzata in [Microsoft Defender per Office 365,](office-365-atp.md)i dettagli su tale indagine sono disponibili durante e dopo il processo di indagine automatizzata. Se si dispone delle autorizzazioni necessarie, è possibile visualizzare tali dettagli nel Centro sicurezza. I dettagli dell'indagine forniscono lo stato aggiornato e la possibilità di approvare eventuali azioni in sospeso.
