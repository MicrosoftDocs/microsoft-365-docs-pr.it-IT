...
Le organizzazioni di Microsoft 365 con [Microsoft Defender per Office 365](defender-for-office-365.md) incluso nell'abbonamento o acquistate come componente aggiuntivo possono abilitare allegati sicuri per SharePoint, OneDrive e Microsoft Teams per la creazione di report e la protezione avanzate. Per ulteriori informazioni, vedere [Allegati sicuri per SharePoint, OneDrive e Microsoft Teams.](mdo-for-spo-odb-and-teams.md)
...
Per ulteriori informazioni sull'antivirus in SharePoint Online, OneDrive e Microsoft Teams, vedere [Protect against threats](protect-against-threats.md) e Turn on Safe Attachments for [SharePoint, OneDrive, and Microsoft Teams.](turn-on-mdo-for-spo-odb-and-teams.md)
