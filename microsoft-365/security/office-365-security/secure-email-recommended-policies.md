...
Questi suggerimenti richiedono agli utenti di usare client di posta elettronica moderni, Outlook per iOS e Android su dispositivi mobili. Outlook per iOS e Android offrono supporto per le migliori funzionalità di Office 365. Queste app Outlook mobili sono inoltre progettate con funzionalità di sicurezza che supportano l'uso mobile e funzionano insieme ad altre funzionalità di sicurezza cloud Microsoft. Per altre informazioni, vedi domande [frequenti Outlook per iOS e Android.](/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-faq)
...
||[Applicare criteri di protezione dei dati APP](identity-access-policies.md#apply-app-data-protection-policies)|Assicurati che Outlook sia incluso nell'elenco delle app. Assicurati di aggiornare i criteri per ogni piattaforma (iOS, Android, Windows)|
...
- Seguire "Passaggio 2: Configurare un criterio di accesso condizionale di Azure AD per Exchange Online con ActiveSync (EAS)" nello [scenario 1:](/azure/active-directory/conditional-access/app-protection-based-conditional-access#scenario-1-office-365-apps-require-approved-apps-with-app-protection-policies)le app di Office 365 richiedono app approvate con criteri di protezione delle app, impedendo ai client di Exchange ActiveSync di sfruttare l'autenticazione di base per connettersi a Exchange Online.
...
## <a name="limit-access-to-exchange-online-from-outlook-on-the-web"></a>Limitare l'Exchange Online accesso da Outlook sul Web

È possibile limitare la possibilità per gli utenti di scaricare allegati da Outlook sul Web su dispositivi umnanaged. Gli utenti su questi dispositivi possono visualizzare e modificare questi file usando Office Online senza perdere e archiviare i file nel dispositivo. Puoi anche impedire agli utenti di visualizzare gli allegati in un dispositivo non gestito.

Ecco la procedura:

1. [Connessione a una sessione Exchange Online Remote PowerShell](/powershell/exchange/exchange-online/connect-to-exchange-online-powershell/connect-to-exchange-online-powershell).
...
5. Nel portale di Azure creare un nuovo criterio di accesso condizionale con queste impostazioni:
   ...
   **Assegnazioni** \> **App o azioni cloud** \> **App cloud** \> **Includi** \> **Seleziona app**: selezionare **Office 365 Exchange Online**

   **Controlli di accesso** \> **Sessione:** selezionare **Usa restrizioni applicate dall'app**

## <a name="require-that-ios-and-android-devices-must-use-outlook"></a>Richiedi che i dispositivi iOS e Android utilizzino Outlook

Per garantire che gli utenti di dispositivi iOS e Android possano accedere solo ai contenuti aziendali o dell'istituto di istruzione usando Outlook per iOS e Android, è necessario un criterio di accesso condizionale destinato a questi potenziali utenti.
