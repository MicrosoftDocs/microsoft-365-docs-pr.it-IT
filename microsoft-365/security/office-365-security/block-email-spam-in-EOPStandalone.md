...
description: Informazioni su come configurare i filtri di Office 365 per bloccare la posta indesiderata e impedire i messaggi falsi negativi.
...
---
# <a name="customize-the-anti-spam-filter-with-these-settings"></a>Personalizzare il filtro della posta indesiderata con queste impostazioni

Un amministratore può utilizzare diverse impostazioni del filtro protezione da posta indesiderata per impedire l'invio della posta indesiderata alla posta in arrivo di un utente. Il filtro protezione da posta indesiderata imparerà a bloccare la posta indesiderata e a evitare messaggi falsi negativi se si usano le opzioni elencate qui. In questo contesto, un falso negativo si riferisce a un messaggio di posta indesiderata inviato alla posta in arrivo di un utente.

## <a name="block-ip-addresses-with-a-connection-filter"></a>Bloccare gli indirizzi IP con un filtro connessioni

È possibile personalizzare il filtro protezione da posta indesiderata aggiungendo l'indirizzo IP del mittente all'elenco indirizzi IP bloccati del filtro connessioni:
...
## <a name="email-users-can-also-help-ensure-that-false-negative-and-email-spam-is-blocked-with-spam-filter"></a>Gli utenti della posta elettronica possono contribuire anche a garantire il blocco dei messaggi indesiderati e dei falsi negativi usando il filtro della posta indesiderata

Può risultare utile per le iniziative di protezione dalla posta indesiderata volte a evitare falsi negativi e posta indesiderata, dire agli utenti di aggiungere l'indirizzo del mittente della posta indesiderata all'elenco dei mittenti bloccati in [Outlook](https://support.office.com/article/5ae3ea8e-cf41-4fa0-b02a-3b96e21de089) o [Outlook sul web](https://support.office.com/article/db786e79-54e2-40cc-904f-d89d57b7f41d). Per iniziare in Outlook sul web, fare clic su **Impostazioni** \> **Opzioni** \> **Blocca o consenti** e quindi aggiungere l'indirizzo all'elenco **Mittenti bloccati**, come illustrato di seguito.
...
[Protezione dalla posta indesiderata d Microsoft](anti-spam-protection.md)
