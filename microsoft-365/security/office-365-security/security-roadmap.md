...
|Protezione delle informazioni| Adattare e implementare i criteri di protezione delle informazioni. Tali risorse includono esempi: <br/> * [Protezione delle informazioni di Office 365 per GDPR](https://aka.ms/o365gdpr) <br/> * [Proteggere siti e file di SharePoint Online](secure-sharepoint-online-sites-and-files.md) <br/> <br> Utilizzare i criteri di prevenzione della perdita di dati e gli strumenti di monitoraggio in Microsoft 365 per i dati archiviati in Microsoft 365 (invece di cloud app Security). <br><br>Utilizzare cloud app Security con Microsoft 365 per funzionalità di avviso avanzate (oltre alla prevenzione della perdita di dati).|
