...
|Area|Attività|
|---|---|
|Gestione della sicurezza|<ul><li>Continuare a pianificare le azioni seguenti utilizzando Punteggio sicuro ( <https://securescore.office.com> ).</li><li>Continuare a esaminare regolarmente dashboard e report nel Centro sicurezza Microsoft 365 sicurezza, Cloud App Security e negli strumenti SIEM.</li><li>Continuare a cercare e implementare gli aggiornamenti software.</li><li>Integrare eDiscovery nei processi legali e di risposta alle minacce.</li></ul>|
