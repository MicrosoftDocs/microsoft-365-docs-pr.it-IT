...
Punteggio sicuro di Office 365 analizza la sicurezza dell'organizzazione in base alle attività e alle impostazioni di sicurezza regolari e assegna un punteggio. Per iniziare, prendere nota del punteggio corrente. La regolazione di alcune impostazioni a livello di tenant aumenterà il punteggio. L'obiettivo non è raggiungere il punteggio massimo, ma essere consapevoli delle opportunità di protezione dell'ambiente che non influiscono negativamente sulla produttività degli utenti. Vedere [Microsoft Secure Score](../mtp/microsoft-secure-score.md).
