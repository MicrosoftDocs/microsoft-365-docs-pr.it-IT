...
Allegati sicuri per SharePoint, OneDrive e Microsoft Teams non è abilitato per impostazione predefinita. Per attivarlo, vedere [Attivare allegati sicuri per SharePoint, OneDrive e Microsoft Teams.](turn-on-mdo-for-spo-odb-and-teams.md)
...
I file identificati come dannosi da Microsoft Defender per Office 365 verranno visualizzati nei report per [Microsoft Defender per Office 365](view-reports-for-mdo.md) e in Esplora risorse (e rilevamenti in tempo [reale).](threat-explorer.md)
