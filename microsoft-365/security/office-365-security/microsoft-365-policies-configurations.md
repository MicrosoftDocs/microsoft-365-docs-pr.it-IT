...
- Sono allineati a [Microsoft Secure Score](../mtp/microsoft-secure-score.md) e al punteggio di identità in Azure [AD](/azure/active-directory/fundamentals/identity-secure-score)e aumenteranno questi punteggi per l'organizzazione.
