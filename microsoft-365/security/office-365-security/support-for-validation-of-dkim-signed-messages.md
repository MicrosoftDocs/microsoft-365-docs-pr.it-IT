...
Exchange Online Protection (EOP) e Exchange Online supportano la convalida in ingresso dei messaggi[DKIM](https://www.rfc-editor.org/rfc/rfc6376.txt)(Domain Keys Identified Mail).
...
Gli amministratori possono creare Exchange del flusso [di](/exchange/security-and-compliance/mail-flow-rules/mail-flow-rules) posta elettronica (note anche come regole di trasporto) sui risultati della convalida DKIM. Queste regole del flusso di posta consentiranno agli amministratori di filtrare o instradare i messaggi in base alle esigenze.