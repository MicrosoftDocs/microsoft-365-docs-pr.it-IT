...
- Disattivare l'analisi degli allegati per la ricerca di malware nella cassetta postale personalizzata. Usare Configurare i criteri allegati sicuri [in Defender per Office 365](set-up-atp-safe-attachments-policies.md) per creare un criterio Allegati sicuri con l'impostazione **Disattivato** per allegati sicuri risposta **malware sconosciuto.**
