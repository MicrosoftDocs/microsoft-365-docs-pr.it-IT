...
Microsoft consente agli amministratori della sicurezza di personalizzare le impostazioni di sicurezza per soddisfare le esigenze dell'organizzazione. Anche se, come regola generale, sono disponibili due livelli di sicurezza in EOP e Microsoft Defender per Office 365 che è consigliabile: Standard e Strict. Queste impostazioni sono elencate in [Impostazioni consigliate per EOP e Microsoft Defender per la sicurezza di Office 365.](recommended-settings-for-eop-and-office365-atp.md)
