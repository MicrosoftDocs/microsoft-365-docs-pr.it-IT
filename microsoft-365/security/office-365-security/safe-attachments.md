...
La protezione degli allegati sicuri per i messaggi di posta elettronica è controllata dai criteri Allegati sicuri. Non esiste un criterio allegati sicuri predefinito, quindi per ottenere la protezione degli allegati sicuri, è necessario creare **uno o più criteri allegati sicuri.** Per istruzioni, vedere [Set up Safe Attachments policies in Defender for Office 365.](set-up-safe-attachments-policies.md)
...
L'analisi degli allegati sicuri avviene nella stessa area in cui si trovano i dati di Microsoft 365. Per ulteriori informazioni sull'area geografica del datacenter, vedere [Dove si trovano i dati?](https://products.office.com/where-is-your-data-located?geo=All)
...
Se si utilizza un dispositivo mobile e il rendering dei PDF non viene visualizzato nel visualizzatore di anteprima recapito dinamico nel dispositivo mobile, provare ad aprire il messaggio in Outlook sul Web (in precedenza noto come Outlook Web App) utilizzando il browser per dispositivi mobili.
