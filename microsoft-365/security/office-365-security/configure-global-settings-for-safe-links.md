...
---
# <a name="configure-global-settings-for-safe-links-in-office-365-atp"></a>Configurare le impostazioni globali per Collegamenti sicuri in Office 365 ATP
...
È possibile configurare la maggior parte delle impostazioni dei collegamenti sicuri nei criteri collegamenti sicuri. Per istruzioni, vedere [configurare i criteri dei collegamenti sicuri in Office 365 ATP](set-up-atp-safe-links-policies.md).
...
- Per visualizzare e configurare le impostazioni globali per i collegamenti sicuri, è necessario essere membri di uno dei gruppi di ruoli seguenti:
