...
|Tipo|Proprietà|Valore|Azione|
|---|---|---|---|
|Microsoft Defender per le regole dell'endpoint|Richiedere che il dispositivo sia a o sotto il Punteggio di rischio del computer|Medio|Selezionare|
|
