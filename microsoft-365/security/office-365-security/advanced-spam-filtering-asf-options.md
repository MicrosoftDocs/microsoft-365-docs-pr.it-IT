...
|---|---|---|
|**Collegamenti immagini a siti remoti** <p> *IncreaseScoreWithImageLinks*|I messaggi che contengono collegamenti tag HTML a siti remoti ,ad esempio `<Img>` http, vengono contrassegnati come posta indesiderata.|`X-CustomSpam: Image links to remote sites`|
