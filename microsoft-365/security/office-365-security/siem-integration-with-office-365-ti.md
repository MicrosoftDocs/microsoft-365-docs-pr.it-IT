...
|41|ThreatIntelligenceUrl|Cassaforte Link time-of-block and block override events from Microsoft Defender for Office 365.|
...
> [!IMPORTANT]
> Per configurare l'integrazione SIEM con Microsoft Defender per Office 365, è necessario essere un amministratore globale o disporre del ruolo amministratore della sicurezza nel portale di Microsoft 365 Defender. Per altre informazioni, vedere [Autorizzazioni nel portale di Microsoft 365 Defender](permissions-microsoft-365-security-center.md).
>
