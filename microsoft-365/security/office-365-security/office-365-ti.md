...
Per visualizzare e utilizzare questo dashboard, nel centro sicurezza & conformità di Office 365 accedere a **Threat Management** \> **Dashboard**.
...
Per visualizzare e utilizzare questo report, nel centro sicurezza & conformità di Office 365 accedere a **gestione** \> **Explorer**minacce.
...
Per visualizzare l'elenco degli incidenti correnti per l'organizzazione, nel centro sicurezza & conformità, accedere a operazioni di **Threat management** \> **Verifica** \> degli **incidenti**di gestione delle minacce.
...
> [!TIP]
> Anche se alcuni ruoli, ad esempio amministratore della sicurezza, possono essere assegnati nel centro conformità & sicurezza di Office 365, considerare l'utilizzo dell'interfaccia di amministrazione di Microsoft 365 o di Azure Active Directory. Per informazioni sui ruoli, sui gruppi di ruoli e sulle autorizzazioni, vedere le risorse seguenti: <br/><br/> [Autorizzazioni nel Centro sicurezza e conformità di Office 365](permissions-in-the-security-and-compliance-center.md)<br/>
