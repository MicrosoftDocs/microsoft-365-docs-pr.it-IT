...
description: Domande frequenti e risposte per gli amministratori sulla protezione anti-spoofing in Exchange Online e Exchange Online Protection (EOP) autonomo.
ms.openlocfilehash: b39e48fd57b899e6296d40ab10aac265cb4165a3
ms.sourcegitcommit: 9ed3283dd6dd959faeca5c22613f9126261b9590
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 04/16/2020
ms.locfileid: "43529860"
---
# <a name="anti-spoofing-protection-faq-in-office-365"></a>Domande frequenti sulla protezione anti-spoofing in Office 365

In questo argomento sono riportate le domande frequenti e le risposte sulla protezione anti-spoofing per i clienti di Office 365 con cassette postali in Exchange Online o autonomo Exchange Online Protection (EOP) clienti senza cassette postali di Exchange Online.
...
Per domande e risposte sulla protezione antimalware, vedere le domande [frequenti sulla protezione anti-malware in Office 365](anti-malware-protection-faq-eop.md)
...
## <a name="is-spoof-intelligence-available-to-office-365-customers-without-atp"></a>L'intelligenza spoof è disponibile per i clienti di Office 365 senza ATP?

Sì. A ottobre 2018, la spoofing Intelligence è disponibile per tutte le organizzazioni con cassette postali di Exchange Online e organizzazioni EOP autonome senza cassette postali di Exchange Online.

La tecnologia antispoofing inizialmente è stata distribuita alle organizzazioni che avevano abbonamenti di Office 365 Enterprise E5 o il componente aggiuntivo di Office 365 Advanced Threat Protection (ATP) per la sottoscrizione.
...
Quasi tutti i servizi di posta elettronica di grandi dimensioni implementano i tradizionali controlli SPF, DKIM e DMARC. Alcuni servizi hanno altri controlli più rigorosi, ma alcuni si spostano fino a Office 365 per bloccare la posta elettronica non autenticata e trattarli come messaggi falsificati. Tuttavia, il settore è sempre più attento ai problemi relativi alla posta elettronica non autenticata, in particolare a causa del problema del phishing.
...
Si consiglia di disabilitare questa funzionalità poiché non fornisce quasi nessun vantaggio aggiuntivo per il rilevamento di messaggi di posta indesiderata o di phishing e genera invece falsi positivi principalmente. Per ulteriori informazioni, vedere le [Opzioni avanzate per il filtro della posta indesiderata (ASF) in Office 365](advanced-spam-filtering-asf-options.md).
