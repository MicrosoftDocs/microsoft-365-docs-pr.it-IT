...
|`SFTY`|Il messaggio è stato identificato come phishing e sarà anche contrassegnato con uno dei valori seguenti: <ul><li>9.19: imitazione del dominio. Il dominio di invio sta tentando di [sostituirsi a un dominio protetto](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365). Il suggerimento di sicurezza per l'imitazione dei domini viene aggiunto al messaggio (se abilitato).</li><li>9.20: imitazione dell'utente. Il mittente sta provando a imitare un utente nell'organizzazione del destinatario o un [utente protetto specificato in un criterio anti-phishing](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365) in Microsoft Defender per Office 365. Il suggerimento di sicurezza per l'imitazione degli utenti viene aggiunto al messaggio (se abilitato).</li></ul>|
