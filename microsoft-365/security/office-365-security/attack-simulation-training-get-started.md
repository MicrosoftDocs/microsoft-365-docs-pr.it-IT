...
> [!NOTE]
> La formazione per la simulazione degli attacchi sostituisce la vecchia esperienza simulatore di attacchi v1 descritta in Simulatore di attacchi [in Microsoft Defender per Office 365.](attack-simulator.md)
...
- I dati correlati alla simulazione e alla formazione degli attacchi vengono archiviati con altri dati dei clienti per i servizi di Microsoft 365. Per altre informazioni, vedere [Percorsi dei dati di Microsoft 365.](../../enterprise/o365-data-locations.md) La simulazione degli attacchi è disponibile nelle aree geografiche seguenti: NAM, APC, EUR, IND, CAN, AUS, FRA, GBR, JPN e KOR.
