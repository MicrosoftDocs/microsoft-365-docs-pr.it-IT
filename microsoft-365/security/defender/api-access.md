...
Microsoft 365 Defender espone gran parte dei dati e delle azioni tramite un set di API programmatiche. Queste API consentono di automatizzare i flussi di lavoro e di usare Microsoft 365 funzionalità di Defender.
...
5. Usa il token per accedere Microsoft 365'API Defender.
...
4. Usa il token per accedere Microsoft 365'API Defender.

Per altre informazioni, vedi **[Creare un'app per accedere Microsoft 365 API defender per conto di un utente.](api-create-app-user-context.md)**
...
Per altre informazioni, vedi **[Creare un'app con accesso partner alle API Microsoft 365 Defender](api-partner-access.md)**.
