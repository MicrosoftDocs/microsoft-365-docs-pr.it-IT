...
|**Configurare Microsoft Defender per le funzionalità di endpoint** :<br>* Windows Defender Antivirus <br>* Exploit Protection <br> * Riduzione della superficie di attacco <br> * Isolamento basato sull'hardware <br>* Accesso alla cartella controllata     |         |![segno di spunta verde](../media/green-check-mark.png) |
...
|**Distribuire [Microsoft Defender per identificare](https://docs.microsoft.com/azure-advanced-threat-protection/what-is-atp)** il monitoraggio e la protezione dalle minacce mirate all'ambiente Active Directory locale.   |         |![segno di spunta verde](../media/green-check-mark.png) |
|Utilizzare **Azure Defender** _ per monitorare le minacce tra carichi di lavoro ibridi e cloud. Defender_ di Azure include un livello di funzionalità gratuito e un livello standard di funzionalità pagate in base alle ore o alle transazioni delle risorse.|         |         |
...
- **Esaminare settimanalmente gli utenti più importanti di malware e phishing** , utilizzare Microsoft Defender per Office 365 Threat Explorer per esaminare gli utenti più importanti con malware e phishing e per individuare la causa principale del motivo per cui tali utenti sono interessati.
