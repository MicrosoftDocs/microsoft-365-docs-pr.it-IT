...
|---|---|---|
|Tutti i livelli di protezione | [Usare il controllo delle app di accesso condizionale in Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-aad#configure-integration-with-azure-ad) |In questo modo l'IdP (Azure AD) viene configurato per l'utilizzo con Cloud App Security. |
...
|---|---|
|Protezione di base | Monitorare il traffico da dispositivi non gestiti<br><br>Aggiungere protezione ai download di file da dispositivi non gestiti | 
...
Per altre informazioni, vedi [Proteggere le app con Microsoft Cloud App Security Conditional Access App Control.](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad) 
...
Questi sono esempi. Ulteriori modelli di criteri vengono aggiunti a intervalli regolari. Per esempi su come applicare una protezione aggiuntiva a app specifiche, vedi [Protezione delle app connesse.](https://docs.microsoft.com/cloud-app-security/protect-connected-apps) 

[In che modo Cloud App Security](https://docs.microsoft.com/cloud-app-security/protect-box) aiuta a proteggere l'ambiente Box dimostra i tipi di controlli che possono aiutarti a proteggere i dati business in Box e in altre app con dati sensibili.
...
|:---------------|:-------|
| Protezione di base |Avvisa quando i file contenenti questo tipo di informazioni riservate ("Numero carta di credito") vengono condivisi all'esterno dell'organizzazione <br><br>Blocca download di file contenenti questo tipo di informazioni riservate ("Numero carta di credito") nei dispositivi non gestiti|
| Dati sensibili  | Proteggere i download di file contenenti questo tipo di informazioni riservate ("Numero di carta di credito") nei dispositivi gestiti <br><br>Blocca download di file contenenti questo tipo di informazioni riservate ("Numero carta di credito") nei dispositivi non gestiti <br><br>Avvisa quando un file con su di queste etichette viene caricato in OneDrive for Business o Box (dati dei clienti, risorse umane: dati sullo stipendio, risorse umane, dati dei dipendenti)|
...
Per altre informazioni sull'uso di Cloud App Security, vedi [la documentazione di Microsoft Cloud App Security.](https://docs.microsoft.com//cloud-app-security/) 