...
- **Ruoli globali di Azure Active Directory (Azure AD)**
- **Accesso al ruolo personalizzato**

Gli account assegnati ai ruoli **globali di Azure AD** seguenti possono accedere ai dati e alle funzionalità di Microsoft 365 Defender:
...
>! [NOTA] Questo articolo si applica solo alla gestione dei ruoli globali di Azure AD. Per ulteriori informazioni sull'utilizzo del controllo di accesso basato sui ruoli personalizzato, vedere Ruoli personalizzati per il controllo di [accesso basato sui ruoli.](custom-roles.md)
