...
| Microsoft Defender per identità | Difendersi da minacce avanzate, identità compromesse e insiders dannosi che utilizzano segnali correlati di Active Directory |
...
Microsoft 365 Defender garantisce una migliore visibilità, correlazione e correzione quando si distribuiscono servizi più supportati.

### <a name="benefits-of-full-deployment"></a>Vantaggi della distribuzione completa
Per ottenere i vantaggi completi di Microsoft 365 Defender, è consigliabile distribuire tutti i servizi supportati. Di seguito sono illustrati alcuni dei vantaggi principali della distribuzione completa:
...
Ogni servizio supportato distribuito fornisce un insieme estremamente ricco di segnali non elaborati e informazioni correlate. Anche se la distribuzione limitata non causa la disattivazione della funzionalità Microsoft 365 Defender, la sua capacità di fornire una visibilità completa tra gli endpoint, le app, i dati e le identità è intaccata. Allo stesso tempo, le funzionalità di correzione si applicano solo alle entità che possono essere gestite dai servizi che sono stati distribuiti.
...
|Microsoft Defender per Office 365 | -Stati di posta e cassette postali e eventi RAW<br />-Rilevamento di messaggi di posta elettronica, allegati e collegamenti | -Cassette postali<br />-Account Microsoft 365 |
| Microsoft Defender per identità | -Segnali di Active Directory, inclusi gli eventi di autenticazione<br />-Rilevamento comportamentale relativo all'identità | Identità |
...
| ------ | ------ | ------ |
| Microsoft Defender ATP | [Guida alla distribuzione di Microsoft Defender per endpoint](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/deployment-phases) | *Vedere Provisioning instructions* |
|Microsoft Defender per Office 365 | *None, provisioning con Office 365* | [Configurare i criteri di Microsoft Defender per Office 365](https://docs.microsoft.com/microsoft-365/security/office-365-security/office-365-atp#configure-atp-policies) |
| Microsoft Defender per identità | [Guida introduttiva: creare l'istanza di Microsoft Defender per l'identità](https://docs.microsoft.com/azure-advanced-threat-protection/install-atp-step1) | *Vedere Provisioning instructions* |
...
Dopo aver distribuito i servizi supportati, [attiva Microsoft 365 Defender](mtp-enable.md).
