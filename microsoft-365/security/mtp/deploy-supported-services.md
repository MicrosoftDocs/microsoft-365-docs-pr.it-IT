...
[Microsoft 365 Defender](microsoft-threat-protection.md) integra vari servizi di sicurezza Microsoft per fornire funzionalità centralizzate di rilevamento, prevenzione e indagine contro attacchi sofisticati. In questo articolo vengono descritti i servizi supportati, i relativi requisiti di licenza, i vantaggi e le limitazioni associati alla distribuzione di uno o più servizi e i collegamenti a come è possibile distribuirli completamente singolarmente.
...
| ------ | ------ | ------ |
| Microsoft Defender per endpoint | [Guida alla distribuzione di Microsoft Defender for Endpoint](/windows/security/threat-protection/microsoft-defender-atp/deployment-phases) | *Vedere le istruzioni per il provisioning* |
|Microsoft Defender per Office 365 | *Nessuno, provisioning con Office 365* | [Configurazione criteri di Microsoft Defender per Office 365](../office-365-security/office-365-atp.md#configure-atp-policies) |
| Che cosa è Microsoft Defender per identità? | [Guida introduttiva: Creare l'istanza di Microsoft Defender for Identity](/azure-advanced-threat-protection/install-atp-step1) | *Vedere le istruzioni per il provisioning* |
...
- [Panoramica di Microsoft Defender for Endpoint](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)
