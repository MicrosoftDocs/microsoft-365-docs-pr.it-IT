...
## <a name="at-a-glance-view-of-your-microsoft-365-environment"></a>Visualizzazione a colpo d'occhio dell'ambiente Microsoft 365
...
Le schede rientrano liberamente nelle categorie seguenti:

- **Identità**: monitorare le identità nell'organizzazione e tenere conto dei comportamenti sospetti o rischiosi. [Per ulteriori informazioni, vedere Identity Protection](https://docs.microsoft.com/azure/active-directory/identity-protection/overview-identity-protection)
- **Informazioni** sull'attività degli utenti in grado di determinare la divulgazione di dati non autorizzati.
- **Dispositivi** : informazioni aggiornate su avvisi, attività di violazione e altre minacce sui dispositivi.
- **Apps** -acquisire informazioni su come vengono utilizzate le app Cloud nell'organizzazione. [Per ulteriori informazioni, vedere app per la sicurezza delle applicazioni cloud](https://docs.microsoft.com/cloud-app-security/discovered-apps)

## <a name="explore-what-the-security-center-has-to-offer"></a>Esplorare ciò che il Centro sicurezza deve offrire
