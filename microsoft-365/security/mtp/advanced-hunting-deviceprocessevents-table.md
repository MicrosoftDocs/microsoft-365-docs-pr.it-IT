...
| `ProcessIntegrityLevel` | stringa | Livello di integrità del processo appena creato. Windows assegna i livelli di integrità ai processi in base a determinate caratteristiche, ad esempio se sono stati avviati da internet scaricati. Questi livelli di integrità influenzano le autorizzazioni per le risorse |
