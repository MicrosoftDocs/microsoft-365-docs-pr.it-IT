...
Per usare la ricerca avanzata o altre funzionalità di [Microsoft 365 Defender,](microsoft-threat-protection.md) è necessario un ruolo appropriato in Azure Active Directory. Inoltre, l'accesso ai dati degli endpoint è determinato dalle impostazioni RBAC (Role-Based Access Control) in Microsoft Defender for Endpoint. [Informazioni sulla gestione dell'accesso a Microsoft 365 Defender](mtp-permissions.md)
