...
L'accesso a Microsoft 365 Defender può essere gestito collettivamente utilizzando [i ruoli globali in Azure Active Directory (AAD)](mtp-permissions.md)
...
- Microsoft Defender for Endpoint - [Modificare i ruoli in Microsoft Defender for Endpoint](/windows/security/threat-protection/microsoft-defender-atp/user-roles)
...
- [Gestire l'accesso a Microsoft 365 Defender](mtp-permissions.md)
