...
2.  Verificare la configurazione del controller di dominio di testing:
    ...
    - Verificare che [Microsoft Defender per Identity e Microsoft cloud app Security Integration](https://docs.microsoft.com/cloud-app-security/aatp-integration) sia stato abilitato.
...
**Avviso: l'iniezione di processo sospetta osservata (origine: Microsoft Defender per endpoint EDR)**
...
**Avviso: comportamento imprevisto rilevato da un processo eseguito senza argomenti della riga di comando (origine: Microsoft Defender per endpoint EDR)**
...
**Avviso: User and IP address Reconnaissance (SMB) (origine: Microsoft Defender per Identity)**
