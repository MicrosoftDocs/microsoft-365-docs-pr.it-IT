...
8. Assicurarsi che **l'opzione Non tenere traccia** quando gli utenti fanno clic su collegamenti sicuri non sia selezionata, mentre le altre opzioni sono selezionate. Per [informazioni dettagliate, vedere Safe Links settings.](../office-365-security/recommended-settings-for-eop-and-office365-atp.md) Fare clic su **Salva**. 
