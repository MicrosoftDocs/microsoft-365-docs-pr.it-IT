...
|[Fase di simulazione d'attacco](mtp-pilot-simulate.md) | Eseguire la simulazione di attacco per l'ambiente pilota Microsoft 365 Defender.
|:-------|:-----|
