...
Questa pagina descrive come creare un'applicazione per ottenere l'accesso programmatico a Microsoft 365 Defender per conto di un singolo utente.

Se è necessario l'accesso programmatico a Microsoft 365 Defender senza un utente definito (ad esempio, se si sta scrivendo un'app in background o un daemon), vedere Creare un'app per accedere a [Microsoft 365 Defender](api-create-app-web.md)senza un utente. Se è necessario fornire l'accesso a più tenant, ad esempio se si serve un'organizzazione di grandi dimensioni o un gruppo di clienti, vedere Creare un'app con accesso partner alle API di [Microsoft 365 Defender.](api-partner-access.md) Se non si è sicuri del tipo di accesso necessario, vedere [Introduzione.](api-access.md)
