...
La preparazione è fondamentale per una distribuzione corretta. Questa sezione guiderà l'utente attraverso gli elementi da considerare durante la preparazione alla creazione di un ambiente di prova o pilota per la distribuzione di Microsoft 365 Defender.
...
Identificare tutte le parti interessate coinvolte nel progetto e chi potrebbe dover firmare, rivedere o rimanere informati, sia per la valutazione che per l'esecuzione di un progetto pilota.
...
| Nome                 | Ruolo                                                                                                                                                                                                          | Azione |
|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|
| Immettere il nome e l'indirizzo di posta elettronica | **Chief Information Security Officer (CISO)** Un rappresentante esecutivo che funge da sponsor all'interno dell'organizzazione *per la distribuzione della nuova tecnologia.*                                                  | Allora     |
| Immettere il nome e l'indirizzo di posta elettronica | **Head of Cyber Defense Operations Center (CDOC)** *A representative from the CDOC team in charge of defining how this change is aligned with the processes in the customers security operations team.*       | Allora     |
| Immettere il nome e l'indirizzo di posta elettronica | **Security Architect** *A representative from the Security team in charge of defining how this change is aligned with the core Security architecture in the organization.*                         | R      |
| Immettere il nome e l'indirizzo di posta elettronica | **Workplace Architect** Un rappresentante del team IT responsabile della definizione del modo in cui questa modifica è allineata all'architettura aziendale di base *dell'organizzazione.*                             | R      |
| Immettere il nome e l'indirizzo di posta elettronica | **Security Analyst** *A representative from the CDOC team who can provide feedback on the detection capabilities, user experience, and overall usefulness of this change from a security operations perspective.* | I      |
...
|Microsoft Cloud App Security| Microsoft Cloud App Security è un Cloud Access Security Broker (CASB) che opera su più cloud. Offre visibilità avanzata, controllo sui viaggi dei dati e analisi sofisticate per identificare e contrastare le minacce informatiche in tutti i servizi cloud. <br> [Altre informazioni](https://docs.microsoft.com/cloud-app-security/).                                                                                                                                                                                                                                                                                                                                                                       |3                    |
