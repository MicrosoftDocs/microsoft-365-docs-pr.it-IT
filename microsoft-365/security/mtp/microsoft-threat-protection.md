...
In questa guida interattiva scoprirai come proteggere l'organizzazione con Microsoft 365 Defender. Verrà illustrato come Microsoft 365 Defender consente di rilevare i rischi per la sicurezza, analizzare gli attacchi all'organizzazione e prevenire automaticamente attività dannose.

> [!VIDEO https://aka.ms/M365Defender-InteractiveGuide]



La famiglia di prodotti Microsoft 365 Defender protegge: 
...
L'esclusivo livello multi-prodotto di Microsoft 365 Defender aggiunge i singoli componenti della famiglia di prodotti a:
- Proteggiti dagli attacchi e coordina le risposte difensive in tutta la famiglia di prodotti tramite la condivisione dei segnali e le azioni automatizzate
- Narra la storia completa dell'attacco tra avvisi di prodotto, comportamenti e contesto per i team di sicurezza unendo i dati sugli avvisi, gli eventi sospetti e le risorse influenzate agli "incidenti"
...
- **Coda** degli eventi imprevisti combinati: per aiutare i professionisti della sicurezza a concentrarsi sugli elementi critici garantendo l'ambito completo degli attacchi, le risorse influenzate e le azioni di correzione automatizzate vengono raggruppate e visualizzate in modo corretto. 
- **Risposta automatica alle** minacce: le informazioni critiche sulle minacce vengono condivise in tempo reale tra i prodotti Microsoft 365 Defender per impedire la progressione di un attacco. Ad esempio, se viene rilevato un file dannoso in un endpoint protetto da Microsoft Defender for Endpoint, verrà indicato a Defender per Office 365 di analizzare e rimuovere il file da tutti i messaggi di posta elettronica. Il file verrà bloccato a vista dall'intera famiglia di prodotti di sicurezza di Microsoft 365.
