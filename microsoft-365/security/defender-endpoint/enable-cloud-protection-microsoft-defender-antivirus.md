...
> [!NOTE]
> Se l'impostazione configura **l'override** dell'impostazione locale per la segnalazione di Criteri di gruppo di Microsoft MAPS è impostata su **Disabilitato,** l'impostazione di protezione basata su **cloud** in Windows Impostazioni sarà disattivata e non disponibile. Le modifiche apportate tramite un oggetto Criteri di gruppo devono prima essere distribuite a singoli endpoint prima che l'impostazione venga aggiornata in Windows Impostazioni.
