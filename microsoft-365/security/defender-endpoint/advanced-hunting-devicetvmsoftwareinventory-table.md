...
DeviceTVMSoftwareInventory contiene tutto il software che la gestione delle minacce e delle vulnerabilità è stata in grado di associare a un cpe (Common Platform Enumeration), sia esso vulnerabile o meno.
...
| `EndOfSupportDate` | stringa | Data di fine del supporto (EOS) o di fine vita (EOL) del prodotto software. |
