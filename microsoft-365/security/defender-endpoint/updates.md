...
Viene seguito il modello di implementazione graduale seguente:
...
Puoi assegnare un computer a un canale di aggiornamento per definire la cadenza in cui un computer riceve aggiornamenti giornalieri delle definizioni.
