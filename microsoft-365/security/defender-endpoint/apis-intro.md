...
---
# <a name="access-the-microsoft-defender-for-endpoint-apis"></a>Accedere alle API di Microsoft Defender for Endpoint 
...
- **Contesto applicazione: (scelta consigliata)** <br>
  ...
  5. Usare il token per accedere all'API di Microsoft Defender ATP
...
- **Contesto utente:** <br>
  ...
  4. Usare il token per accedere all'API di Microsoft Defender ATP
