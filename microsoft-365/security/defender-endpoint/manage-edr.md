...
---
# <a name="manage-endpoint-detection-and-response-capabilities"></a>Gestire le funzionalità di rilevamento e risposta degli endpoint

[!INCLUDE [Microsoft 365 Defender rebranding](../../includes/microsoft-defender.md)]


Gestire la coda degli avvisi, analizzare i dispositivi nell'elenco dei dispositivi, eseguire azioni di risposta e cercare possibili minacce nell'organizzazione usando la ricerca avanzata.
