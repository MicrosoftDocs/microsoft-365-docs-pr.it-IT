...
:---|:---|:---
[Elenco Avvisi correlati agli utenti](get-user-related-alerts.md) | [raccolta avvisi](alerts.md) |  Elencare tutti gli avvisi associati a un [utente](user.md).
[Elenco Dispositivi correlati agli utenti](get-user-related-machines.md) | [raccolta computer](machine.md) | Elencare tutti i dispositivi connessi da un [utente.](user.md)
