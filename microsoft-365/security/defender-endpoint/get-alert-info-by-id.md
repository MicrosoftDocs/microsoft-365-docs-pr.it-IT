...
---
# <a name="get-alert-information-by-id-api"></a>Ottenere informazioni sugli avvisi tramite l'API ID
...
Recupera un avviso [specifico in](alerts.md) base al relativo ID.


## <a name="limitations"></a>Limitazioni
1. È possibile ottenere gli avvisi aggiornati per l'ultima volta in base al periodo di conservazione configurato.
...
Se ha esito positivo, questo metodo restituisce 200 OK e l'entità [di](alerts.md) avviso nel corpo della risposta. Se l'avviso con l'ID specificato non è stato trovato - 404 Non trovato.
