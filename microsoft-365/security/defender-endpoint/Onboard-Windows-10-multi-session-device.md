...
Seguire le istruzioni riportate in [Onboard non persistent virtual desktop infrastructure VDI devices](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/configure-endpoints-vdi#onboard-non-persistent-virtual-desktop-infrastructure-vdi-devices-1).
...
1. Aprire il file ZIP del pacchetto di configurazione VDI (WindowsDefenderATPOnboardingPackage.zip)  
    - Nel riquadro di spostamento di Microsoft Defender Security Center seleziona  >  **Impostazioni Onboarding.** 
    - Seleziona Windows 10 come sistema operativo. 
    - Nel campo **Metodo di distribuzione** selezionare Gli script di onboarding VDI per gli endpoint non persistenti. 
    - Fai **clic su Scarica** pacchetto e salva il file ZIP. 
...
Fare **clic su OK** e chiudere tutte le finestre della Console Gestione Criteri di gruppo aperte.
