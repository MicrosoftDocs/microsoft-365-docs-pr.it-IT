...
2. WpnService (Windows servizio di sistema notifiche Push) non è disabilitato.

Fare riferimento agli articoli seguenti per comprendere appieno il comportamento e i requisiti del servizio WpnService:
- [Windows Panoramica Notification Services push (WNS)](/windows/uwp/design/shell/tiles-and-notifications/windows-push-notification-services--wns--overview)
- [Enterprise Configurazioni firewall e proxy per supportare il traffico WNS](/windows/uwp/design/shell/tiles-and-notifications/firewall-allowlist-config)
