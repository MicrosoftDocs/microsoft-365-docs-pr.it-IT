...
1. Devono essere installati gli aggiornamenti seguenti di Windows.
    - Per Windows 1809: installare Windows aggiornamento [KB5003217](https://support.microsoft.com/topic/may-20-2021-kb5003217-os-build-17763-1971-preview-08687c95-0740-421b-a205-54aa2c716b46)
    - Per Windows 1909: installare Windows aggiornamento [KB5003212](https://support.microsoft.com/topic/may-20-2021-kb5003212-os-build-18363-1593-preview-05381524-8380-4b30-b783-e330cad3d4a1)
    - Per Windows 2004 o versioni successive

1. Se stai pianificando la distribuzione dei criteri tramite Criteri di gruppo, il dispositivo deve essere aggiunto all'MDATP; se si prevede di distribuire i criteri tramite MEM, il dispositivo deve essere aggiunto a Intune.
...
\*Questo criterio deve essere utilizzato insieme a Abilita restrizioni di **stampa per il controllo dei dispositivi.**
...
### <a name="scenario-1-block-people-from-printing-via-any-non-corporate-printer-using-intune"></a>Scenario 1: impedire la stampa degli utenti tramite una stampante non aziendale tramite Intune
...
### <a name="scenario-2-allow-specific-approved-usb-printers-using-intune"></a>Scenario 2: consentire specifiche stampanti USB approvate con Intune
...
### <a name="scenario-1-block-people-from-printing-via-any-non-corporate-printer-using-group-policy"></a>Scenario 1: impedire la stampa degli utenti tramite una stampante non aziendale tramite Criteri di gruppo
...
- Applica criteri sull'utente:
  ...
  Configurazione utente \> Modelli amministrativi \> Stampanti del Pannello di \> controllo: Abilita restrizioni di stampa per il controllo del dispositivo
...
### <a name="scenario-2-allow-specific-approved-usb-printers-using-group-policy"></a>Scenario 2: consentire stampanti USB approvate specifiche tramite Criteri di gruppo
...
- Applica criteri sull'utente:
  ...
  Configurazione utente \> Modelli amministrativi \> Stampanti del Pannello di \> controllo: elenco dei dispositivi di stampa approvati connessi tramite USB
