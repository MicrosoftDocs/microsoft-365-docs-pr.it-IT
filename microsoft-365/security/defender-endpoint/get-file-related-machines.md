...
---
# <a name="get-file-related-machines-api"></a>API Per ottenere i computer correlati ai file
...
Recupera una raccolta di [machines correlati](machine.md) a un determinato hash di file.
...
Se ha esito positivo e il file [](machine.md) esiste- 200 OK con l'elenco delle entità del computer nel corpo. Se il file non esiste - 404 Non trovato.
