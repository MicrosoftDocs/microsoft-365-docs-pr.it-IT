...
In alcune versioni di Windows, Microsoft Defender Antivirus potrebbe essere stato disinstallato o disabilitato. Questo perché Microsoft Defender Antivirus non entra in modalità passiva o disabilitata quando installi un prodotto antivirus di terze parti, ad esempio Symantec. Per altre informazioni, vedi Compatibilità [con Microsoft Defender Antivirus.](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-antivirus/microsoft-defender-antivirus-compatibility) 
...
2. Eseguire i cmdlet di PowerShell seguenti: `Dism /online /Get-FeatureInfo /FeatureName:Windows-Defender-Features` <br/>
