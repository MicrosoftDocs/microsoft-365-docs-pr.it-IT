...
Recupera l'oggetto User correlato a un avviso specifico.
...
In caso di esito positivo e avviso ed esiste un utente- 200 OK con l'utente nel corpo. Se avviso o utente non trovato - 404 Non trovato.
