...
La guida è disponibile in formato PDF per la visualizzazione offline:

- [Scaricare la guida in formato PDF](https://www.microsoft.com/download/details.aspx?id=54795)

Puoi anche scaricare powershell che abiliterà automaticamente tutte le impostazioni descritte nella guida. Puoi ottenere lo script insieme al download pdf precedente o singolarmente da PowerShell Gallery:
