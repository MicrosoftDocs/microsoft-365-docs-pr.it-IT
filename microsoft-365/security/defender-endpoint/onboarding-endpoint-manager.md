...
[Microsoft Endpoint Manager](/mem/endpoint-manager-overview) è una piattaforma di soluzioni che unifica diversi servizi. Include le [Microsoft Intune](/mem/intune/fundamentals/what-is-intune) per la gestione dei dispositivi basati sul cloud.


In questo argomento vengono guidati gli utenti in:
- Passaggio 1: onboarding dei dispositivi al servizio creando un gruppo in Microsoft Endpoint Manager (MEM) in cui assegnare le configurazioni
- Passaggio 2: Configurazione delle funzionalità di Defender for Endpoint con Microsoft Endpoint Manager
...
-   [Identificazione dei dispositivi o degli utenti di destinazione](#identify-target-devices-or-users)
    ...
    -   Creazione di Azure Active Directory gruppo (utente o dispositivo)
...
-   [Linee di base della sicurezza di Intune](/mem/intune/protect/security-baseline-settings-defender-atp#microsoft-defender)

Per ulteriori informazioni sulle Microsoft Endpoint Manager, vedere queste risorse:
...
>[!NOTE]
>Intune usa Azure Active Directory (Azure AD) per gestire dispositivi e utenti. Gli amministratori di Intune possono configurare i gruppi in base alle esigenze dell'organizzazione.<br>
Per altre informazioni, vedi [Aggiungere gruppi per organizzare utenti e dispositivi.](/mem/intune/fundamentals/groups-add)
...
2.  Aprire **Gruppi > Nuovo gruppo**.
    ...
    > ![Immagine di Microsoft Endpoint Manager portal1](images/66f724598d9c3319cba27f79dd4617a4.png)

3.  Immettere i dettagli e creare un nuovo gruppo.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal2](images/b1e0206d675ad07db218b63cd9b9abc3.png)
...
7.  Trova l'utente o il dispositivo di test e selezionalo.
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal3](images/149cbfdf221cdbde8159d0ab72644cd0.png)
...
2.  Passare a **Endpoint security > Endpoint detection and response**. Fare clic **su Crea profilo**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal4](images/58dcd48811147feb4ddc17212b7fe840.png)
...
5.  Selezionare le impostazioni in base alle esigenze, quindi **selezionare Avanti.**
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal6](images/cea7e288b5d42a9baf1aef0754ade910.png)

    > [!NOTE]
    > In questo caso, questo è stato popolato automaticamente come Defender per Endpoint è già stato integrato con Intune. Per altre informazioni sull'integrazione, vedi [Abilitare Microsoft Defender per Endpoint in Intune.](/mem/intune/protect/advanced-threat-protection-configure#to-enable-microsoft-defender-atp)
    > 
...
6.  Aggiungere i tag di ambito, se necessario, quindi **selezionare Avanti.**
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal8](images/ef844f52ec2c0d737ce793f68b5e8408.png)
...
7.  Aggiungere un gruppo di test facendo clic su **Seleziona gruppi da includere** e scegliere il gruppo, quindi selezionare **Avanti.**
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal9](images/fc3525e20752da026ec9f46ab4fec64f.png)

8.  Rivedere e accettare, quindi selezionare  **Crea**.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal10](images/289172dbd7bd34d55d24810d9d4d8158.png)

9.  È possibile visualizzare i criteri completati.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal11](images/5a568b6878be8243ea2b9d82d41ed297.png)
...
2.  Passare a **Endpoint security > Antivirus > Create Policy**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal12](images/6b728d6e0d71108d768e368b416ff8ba.png)

3.  Seleziona **Piattaforma - Windows 10 e versioni successive - Windows e profilo - Antivirus Microsoft Defender > Crea**.

4.  Immetti nome e descrizione, quindi seleziona **Avanti.**

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal13](images/a7d738dd4509d65407b7d12beaa3e917.png)

5.  Nella pagina **Impostazioni di configurazione:** imposta le configurazioni necessarie per Antivirus Microsoft Defender (Protezione cloud, Esclusioni, Real-Time Protezione e Correzione).

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal14](images/3840b1576d6f79a1d72eb14760ef5e8c.png)

6.  Aggiungere i tag di ambito, se necessario, quindi **selezionare Avanti.**

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal15](images/2055e4f9b9141525c0eb681e7ba19381.png)

7.  Selezionare i gruppi da includere, assegnarli al gruppo di test, quindi selezionare **Avanti.**

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal16](images/48318a51adee06bff3908e8ad4944dc9.png)

8.  Rivedere e creare, quindi selezionare  **Crea**.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal17](images/dfdadab79112d61bd3693d957084b0ec.png)

9.  Verrà visualizzato il criterio di configurazione creato.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal18](images/38180219e632d6e4ec7bd25a46398da8.png)
...
4.  Seleziona **Piattaforma - Windows 10 e versioni successive - Profilo - Regole di** riduzione della superficie di > Crea .

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal19](images/522d9bb4288dc9c1a957392b51384fdd.png)

5.  Immettere un nome e una descrizione, quindi selezionare **Avanti.**

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal20](images/a5a71fd73ec389f3cdce6d1a6bd1ff31.png)
...
6.  Nella pagina **Impostazioni di configurazione**: Imposta le configurazioni necessarie per le regole di riduzione della superficie di attacco, quindi seleziona **Avanti.**
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal21](images/dd0c00efe615a64a4a368f54257777d0.png)

7.  Aggiungi tag ambito in base alle esigenze, quindi seleziona **Avanti.**

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal22](images/6daa8d347c98fe94a0d9c22797ff6f28.png)

8.  Selezionare i gruppi da includere e assegnare al gruppo di test, quindi selezionare **Avanti.**

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal23](images/45cefc8e4e474321b4d47b4626346597.png)

9. Esaminare i dettagli, quindi selezionare  **Crea**.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal24](images/2c2e87c5fedc87eba17be0cdeffdb17f.png)

10. Visualizzare il criterio.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal25](images/7a631d17cc42500dacad4e995823ffef.png)
...
4.  Selezionare **Windows 10 e versioni successive - Protezione Web > Crea**.
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal26](images/cd7b5a1cbc16cc05f878cdc99ba4c27f.png)

5.  Immettere un nome e una descrizione, quindi selezionare **Avanti.**

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal27](images/5be573a60cd4fa56a86a6668b62dd808.png)
...
6.  Nella pagina **Impostazioni di configurazione**: Impostare le configurazioni necessarie per Protezione Web, quindi selezionare **Avanti.**
    ...
    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal28](images/6104aa33a56fab750cf30ecabef9f5b6.png)

7.  Aggiungere **tag di ambito come richiesto > Avanti**.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal29](images/6daa8d347c98fe94a0d9c22797ff6f28.png)

8.  Selezionare **Assegna al gruppo di test > Avanti**.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal30](images/45cefc8e4e474321b4d47b4626346597.png)

9.  Seleziona **Revisione e crea > crea**.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal31](images/8ee0405f1a96c23d2eb6f737f11c1ae5.png)

10. Visualizzare il criterio.

    > [!div class="mx-imgBorder"]
    > ![Immagine di Microsoft Endpoint Manager portal32](images/e74f6f6c150d017a286e6ed3dffb7757.png)
...
Per informazioni sulla tempistica, vedere [Informazioni sulla configurazione di Intune.](/mem/intune/configuration/device-profile-troubleshoot#how-long-does-it-take-for-devices-to-get-a-policy-profile-or-app-after-they-are-assigned)
...
1.  Apri il portale MEM e passa al criterio pertinente, come illustrato nei passaggi precedenti. L'esempio seguente mostra le impostazioni di protezione di nuova generazione.
    ...
    > [!div class="mx-imgBorder"]
    > [![Immagine di Microsoft Endpoint Manager portal33 ](images/43ab6aa74471ee2977e154a4a5ef2d39.png)](images/43ab6aa74471ee2977e154a4a5ef2d39.png#lightbox)

2.  Selezionare Il **criterio di configurazione** per visualizzare lo stato dei criteri.

    > [!div class="mx-imgBorder"]
    > [![Immagine di Microsoft Endpoint Manager portal34 ](images/55ecaca0e4a022f0e29d45aeed724e6c.png)](images/55ecaca0e4a022f0e29d45aeed724e6c.png#lightbox)

3.  Seleziona  **Stato dispositivo** per visualizzare lo stato.

    > [!div class="mx-imgBorder"]
    > [![Immagine di Microsoft Endpoint Manager portal35 ](images/18a50df62cc38749000dbfb48e9a4c9b.png)](images/18a50df62cc38749000dbfb48e9a4c9b.png#lightbox)

4.  Selezionare  **Stato utente** per visualizzare lo stato.

    > [!div class="mx-imgBorder"]
    > [![Immagine di Microsoft Endpoint Manager portal36 ](images/4e965749ff71178af8873bc91f9fe525.png)](images/4e965749ff71178af8873bc91f9fe525.png#lightbox)
...
5.  Seleziona  **Stato per impostazione** per visualizzare lo stato.
    ...
    > [!div class="mx-imgBorder"]
    > [![Immagine di Microsoft Endpoint Manager portal37 ](images/42acc69d0128ed09804010bdbdf0a43c.png)](images/42acc69d0128ed09804010bdbdf0a43c.png#lightbox)
...
2.  Dopo l'applicazione della configurazione, è necessario Endpoint Protection Defender for Endpoint Protection Service.
...
3.  Dopo aver applicato il criterio in un dispositivo di test, apri un Windows PowerShell e digita `Get-MpPreference` .
...
1.  Nel dispositivo di test, aprire un Windows PowerShell e digitare `(Get-MpPreference).EnableNetworkProtection` .
...
3.  Dopo aver applicato il criterio, aprire un Windows PowerShell e digitare `(Get-MpPreference).EnableNetworkProtection` .
