...
| Comando  | Descrizione   |
|:----|:----|
| `-?` **oppure** `-h`   | Visualizza tutte le opzioni disponibili per lo strumento MpCmdRun |
...
|:----|:----|
| **ValidateMapsConnection non riuscito (800106BA)** **o 0x800106BA** | Il Antivirus Microsoft Defender è disabilitato. Abilitare il servizio e riprovare. Se serve aiuto per ri-abilitare Antivirus Microsoft Defender, vedi [Reinstallare/abilitare](switch-to-microsoft-defender-setup.md#reinstallenable-microsoft-defender-antivirus-on-your-endpoints)Antivirus Microsoft Defender sugli endpoint.<p> **SUGGERIMENTO:** in Windows 10 1909 o versioni precedenti e Windows Server 2019 o versioni precedenti, il servizio era precedentemente denominato *Windows Defender Antivirus*. |
