...
:::image type="content" source="../../media/wdav-bafs-edge.png" alt-text="Screenshot della notifica che il malware è stato trovato in Edge":::

Se si usa Internet Explorer, viene visualizzato un messaggio simile:

:::image type="content" source="../../media/wdav-bafs-ie.png" alt-text="Notifica di Microsoft Defender AV che indica che è stato rilevato malware":::
