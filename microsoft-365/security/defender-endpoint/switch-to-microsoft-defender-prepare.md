...
> [!NOTE]
> Il Microsoft Defender Security Center viene talvolta definito portale defender per endpoint ed è possibile accedervi all'indirizzo [https://aka.ms/MDATPportal](https://aka.ms/MDATPportal) . 
