...
---
# <a name="get-user-related-alerts-api"></a>API per ottenere avvisi correlati all'utente
...
Recupera una raccolta di avvisi correlati a un DETERMINATO ID utente.
...
**L'ID non è l'UPN completo, ma solo il nome utente. (ad esempio, per recuperare gli avvisi user1@contoso.com usare /api/users/user1/alerts)**
...
Se ha esito positivo e l'utente esiste - 200 OK. Se l'utente non esiste- 404 Non trovato. 
