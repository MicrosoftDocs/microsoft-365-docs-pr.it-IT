...
La nuova API Microsoft 365 Defender streaming include eventi di posta elettronica e di avviso oltre agli eventi del dispositivo.
Per altre informazioni, vedi Microsoft 365 Defender [Streaming API](../defender/streaming-api.md).
