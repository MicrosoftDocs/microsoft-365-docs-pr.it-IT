...
### [Caccia in Microsoft 365](./mtp/hunting.md)

### [Secure Score](./mtp/microsoft-secure-score.md)

### [Report]()
#### [Monitorare e visualizzare i report](./mtp/monitoring-and-reporting.md)
#### [Monitoraggio e reporting delle identità](./mtp/monitor-and-report-identities.md)
#### [Monitoraggio e creazione di report dei dati](./mtp/monitor-data.md)
#### [Monitoraggio e Reporting dei dispositivi](./mtp/monitor-devices.md)
#### [Monitoraggio e creazione di report delle app](./mtp/monitor-apps.md)
...
#### [Nuovo Centro sicurezza di Microsoft 365](./office-365-security/microsoft-security-and-compliance.md)
...
##### [Domande frequenti sulla protezione anti-malware](./office-365-security/anti-malware-protection-faq-eop.md)
...
##### [Evitare caratteri non validi nelle regole del filtro di posta indesiderata e nel criterio filtro posta indesiderata](./office-365-security/invalid-characters-hosted-spam-filter-rules-policies.md)
...
##### [Notifica di esempio quando un mittente è bloccato nell'invio di posta indesiderata in uscita](./office-365-security/sample-notification-when-a-sender-is-blocked-sending-outbound-spam.md)
...
##### [La lotta alla posta indesiderata inviata a Office 365](./office-365-security/fighting-junk-email.md)
##### [Rilevamento virus in SharePoint Online](./office-365-security/virus-detection-in-spo.md)
...
##### [Correggere il codice di errore 5.7.7 XX in Exchange Online](./office-365-security/fix-error-code-5-7-7xx-in-exchange-online.md)
...
##### [Invii di amministratore in Office 365](./office-365-security/admin-submission.md)
...
##### [Informazioni dettagliate su spoofing Intelligence Insight](./office-365-security/walkthrough-spoof-intelligence-insight.md)
...
##### [Configurare le notifiche di posta indesiderata dell'utente finale in EOP](./office-365-security/configure-end-user-spam-notifications-in-eop.md)
##### [Configurare le notifiche di posta indesiderata dell'utente finale in Exchange Online](./office-365-security/configure-end-user-spam-notifications-in-exchange-online.md)
##### [Segnalare la posta indesiderata e i tentativi di phishing in Outlook sul Web](./office-365-security/report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop.md)
...
#####[Disattivare la segnalazione della posta indesiderata in Outlook sul Web](./office-365-security/turn-off-junk-email-reporting-in-outlook-on-the-web.md)
#####[Differenza tra posta elettronica indesiderata e posta elettronica in blocco](./office-365-security/what-s-the-difference-between-junk-email-and-bulk-email.md)
...
##### [Utilizzare DMARC per convalidare la posta elettronica](./office-365-security/use-dmarc-to-validate-email.md)
...
##### [Panoramica del Dashboard sulla sicurezza](./office-365-security/security-dashboard.md) 
...
### [Protezione avanzata dalle minacce](./office-365-security/office-365-atp.md)
#### [Attività di configurazione del trifosfato di adenosina per gli amministratori]()
##### [Attività di configurazione dell'amministratore globale]()
...
##### [Attività di configurazione dell'amministratore del ruolo]()
###### [Attivare ATP per SharePoint, OneDrive e Microsoft Teams](./office-365-security/turn-on-atp-for-spo-odb-and-teams.md)
#### [Informazioni sulle più recenti campagne di attacco con Threat Analytics](./mtp/latest-attack-campaigns.md)
#### [Visualizzare e leggere i report ATP](./office-365-security/view-reports-for-atp.md)
#### [Cosa significano le pagine di avviso per i collegamenti sicuri ATP](./office-365-security/atp-safe-links-warning-pages.md)
#### [Utilizzo di inseguimenti di minacce](./office-365-security/threat-trackers.md)
#### [Usare simulatore di attacco in Office 365](./office-365-security/attack-simulator.md)
#### [Proteggere gli utenti con l'analisi e la risposta alle minacce](./office-365-security/keep-users-safe-with-office-365-ti.md)
#### [Esaminare e rispondere automaticamente alle minacce in Office 365](./office-365-security/office-365-air.md)
...
##### [Integrazione di Office 365 ATP con Microsoft Defender ATP](./office-365-security/integrate-office-365-ti-with-wdatp.md)
...
#### [Funzionamento del trifosfato di adenosina]()
##### [Funzionamento di collegamenti sicuri ATP](./office-365-security/how-atp-safe-links-works.md)
##### [Funzionamento degli allegati sicuri di ATP](./office-365-security/how-atp-safe-attachments-works.md)
##### [Dettagli per il recapito dinamico e l'anteprima](./office-365-security/dynamic-delivery-and-previewing.md)
##### [ATP per SharePoint, OneDrive e Microsoft Teams](./office-365-security/atp-for-spo-odb-and-teams.md)
##### [Come funziona l'analisi e la risposta alle minacce](./office-365-security/office-365-ti.md)
##### [Come funziona l'analisi automatizzata e la risposta](./office-365-security/automated-investigation-response-office.md)
...
#### [Siti del team di SharePoint Online isolati](./office-365-security/isolated-sharepoint-online-team-sites.md)
##### [Progettare un sito del team di SharePoint Online isolato](./office-365-security/design-an-isolated-sharepoint-online-team-site.md)
##### [Distribuire un sito del team di SharePoint Online isolato](./office-365-security/deploy-an-isolated-sharepoint-online-team-site.md)
##### [Gestire un sito del team di SharePoint Online isolato](./office-365-security/manage-an-isolated-sharepoint-online-team-site.md)
##### [Sito del team SharePoint Online isolato nell'ambiente di sviluppo/test](./office-365-security/isolated-sharepoint-online-team-site-dev-test-environment.md)
...
### [Funzionalità di protezione legacy]()
