...
Ottiene o aggiorna le informazioni su un modello di analisi dei documenti di SharePoint Syntex usando il titolo del modello (vedere l'[esempio](rest-getbytitle-method.md#examples)).
...
### <a name="get-information-about-the-contoso-contract-model"></a>Ottenere informazioni sul modello Contoso Contract

In questo esempio il nome del modello di analisi dei documenti di Syntex è `Contoso Contract`.
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a>Ottenere ed eliminare il modello Contoso Contract in base al nome

In questo esempio il nome del modello di analisi dei documenti Contoso Contract è `Contoso Contract`.
