...
Se Azure è il provider di hosting DNS, seguire i passaggi di questo articolo per verificare il dominio e configurare i record DNS per posta elettronica, Skype for Business online e così via.
...
Dopo aver aggiunto questi record in Azure, il dominio sarà configurato per l'utilizzo con i servizi Microsoft.
...
**First nameserver:** Utilizzare il valore del server dei nomi assegnato da Azure.  
**Secondo server dei nomi:** Utilizzare il valore del server dei nomi assegnato da Azure.  

![Azure-BP-Redelegate-1-1](../../media/3e4805ea-608a-4df9-8f68-1fbf70d13d08.png)
  
> [!TIP]
> You should use at least two name server records. Se nel sito Web del registrar sono elencati altri server dei nomi, è necessario eliminarli. 
...
2. Utilizzando la **barra di** ricerca nella **pagina Dashboard,** digitare nelle **zone DNS.** Nella visualizzazione dei risultati, selezionare **le zone DNS** nella **sezione** Servizi. Dopo essere stato reindirizzato, selezionare il dominio che si desidera aggiornare.
    
    ![Azure-BP-Configure-1-2](../../media/eb4baad2-92d7-49c9-95e5-1dd8510d5ec9.png)
  
3. Nella pagina **Impostazioni** del dominio selezionare **+ Set** di record nell'area della zona **DNS.**
...
4. Nelle **caselle del** nuovo set di record nell'area Aggiungi set di record selezionare i valori della tabella seguente. 
    ...
    Scegliere i valori **di unità Tipo** **e TTL** dagli elenchi a discesa. 
...
6. Se nella sezione MX Records sono elencati altri record **MX,** è necessario eliminarli. 
    ...
    Prima di tutto, nell'area della zona **DNS,** selezionare il **set di record MX.**
...
6. Aggiungere gli altri tre record CNAME.
    ...
    Nell'area **della zona DNS** selezionare + Set di **record.** Nel set di record vuoto creare quindi un record utilizzando i valori della riga successiva della tabella e quindi selezionare di nuovo **OK** per completare il record. 
