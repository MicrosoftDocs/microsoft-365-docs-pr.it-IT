...
Dopo aver aggiunto questi record in name.com, il dominio sarà configurato per l'utilizzo con i servizi Microsoft.
...
6. Aggiungere il secondo record CNAME.
    ...
    Utilizzare i valori della seconda riga della tabella precedente e quindi selezionare **Aggiungi record** per aggiungere il secondo record. 
...
3. Nella colonna **Dettagli** selezionare **DNS Records+**. 
...
Utilizzare i valori della riga successiva della tabella precedente e quindi selezionare **Aggiungi record** per aggiungere il secondo record.
