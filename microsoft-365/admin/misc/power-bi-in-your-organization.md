...
### <a name="scenario-2-your-organization-has-an-existing-microsoft-365-environment-and-the-user-signing-up-for-power-bi-doesnt-have-a-microsoft-365-account"></a>Scenario 2: l'organizzazione ha un ambiente Microsoft 365 esistente e l'utente che effettua l'iscrizione a Power BI non ha un account Microsoft 365.
...
Non ci sono azioni amministrative che l'organizzazione deve trarre vantaggio da Power BI.
...
Se un utente ha effettuato l'iscrizione a Power BI, ma non si desidera più che dispongano dell'accesso a Power BI, è possibile rimuovere la licenza Power BI per tale utente.
