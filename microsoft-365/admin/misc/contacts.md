...
Se sono necessari contatti condivisi a cui tutti gli utenti dell'organizzazione possono accedere, crearli nell'interfaccia di amministrazione di Microsoft 365. I contatti creati qui possono essere visualizzati da tutti gli utenti dell'organizzazione come parte dell'elenco indirizzi globale.
  
## <a name="how-do-i-add-contacts-in-the-admin-center"></a>Come si aggiungono contatti nell'interfaccia di amministrazione?

1. Nell'interfaccia di amministrazione passare alla **pagina Contatti** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2053302" target="_blank"></a> utenti.
...
È possibile utilizzare i contatti di Microsoft 365 come si desidera, ma esistono limitazioni. Informazioni su altri[Modi per gestire i contatti](ways-to-manage-contacts.md).
...
Visitare il resto della [Guida per amministratori](https://docs.microsoft.com/microsoft-365/admin/) o immettere il proprio feedback di seguito.