...
È possibile bloccare l'utente in modo che non possa accedere all'organizzazione. Cercare l'utente nella home page o nella pagina **Utenti attivi** e selezionarlo. Nella parte superiore del riquadro, sotto il nome  dell'utente, selezionare l'icona Blocca l'utente e quindi selezionare la casella di controllo Blocca l'accesso  dell'utente. [Leggere l'articolo completo](../add-users/assign-admin-roles.md).
