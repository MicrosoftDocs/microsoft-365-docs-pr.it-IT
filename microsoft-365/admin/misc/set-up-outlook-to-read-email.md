...
1. Vai a [admin.microsoft.com/OLS/MySoftware](https://admin.microsoft.com/OLS/MySoftware.aspx).
    
2. Accedere con l'account aziendale o dell'istituto di istruzione.
    
3. In Gestisci installazioni scegliere **Installa**.
    
## <a name="set-up-an-email-account-in-outlook-2016-for-mac"></a>Configurare la posta elettronica in Outlook 2016 per Mac
...
Per determinare l'abbonamento, vedere [Quale abbonamento si dispone?](../admin-overview/what-subscription-do-i-have.md)
