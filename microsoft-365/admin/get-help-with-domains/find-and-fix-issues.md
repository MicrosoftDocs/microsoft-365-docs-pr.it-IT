...
[Risoluzione dei problemi: controllare i dati sulla modifica del dominio verificato](https://docs.microsoft.com/azure/active-directory/reports-monitoring/troubleshoot-audit-data-verified-domain)
