...
description: Scopri come trasferire manualmente i dati tra due Microsoft 365 quando hai modificato il piano o il nome della società o hai combinato più sottoscrizioni in uno.
...
Prepararsi a rimboccarsi le mani e bloccare un blocco di tempo nel calendario: il trasferimento dei dati tra due account Microsoft 365 è un processo manuale, complicato e dispendioso in termini di tempo. Non si tratta di un processo automatizzato o supportato. Questo articolo illustra la procedura.
  
> [!CAUTION]
> Durante il processo si verificano tempi di inazione in cui la posta elettronica, Skype for Business e un sito Web pubblico ospitato Microsoft 365 non funzionano. Gli utenti riceveranno nuovi nomi utente e nuove password e dovranno reimpostare Outlook.
...
|Annulla l'abbonamento per il piano con cui hai finito chiamando il supporto Microsoft per Microsoft 365.  <br/> | Verificare che il nuovo abbonamento funzioni e che tutti i dati siano stati trasferiti.  <br/>  [Contattare il supporto tecnico](../../business-video/get-help-support.md) per annullare l'abbonamento precedente.  <br/> |
...
Se si trasferiscono dati da Microsoft 365 a Microsoft 365 Midsize Business o Microsoft 365 Enterprise, le pagine di amministrazione sono strutturate in modo diverso. Guarda un [video: Introduzione Microsoft 365 Enterprise](../index.yml)e vai alle posizioni seguenti per esaminare le impostazioni di amministrazione.
...
|**Amministratore** \> **Skype for Business** <br/> |Impostazioni Skype for Business aggiuntive  <br/> |
...
Se si dispone di un sito Web pubblico ospitato Microsoft 365, è necessario salvarlo e crearlo di nuovo nel nuovo abbonamento.
...
### <a name="onedrive-for-business-data"></a>OneDrive Per i dati business:

Chiedere agli utenti di copiare/OneDrive for Business contenuto nel [computer](https://support.microsoft.com/office/59b1de2b-519e-4d3a-8f45-51647cf291cd)e quindi aggiungerlo di nuovo al nuovo abbonamento.

### <a name="onenote"></a>OneNote 

Chiedere agli utenti [di eseguire il backup OneNote](https://support.microsoft.com/office/back-up-notes-f58b34b0-611d-435e-87fa-7942a1767af4?ui=en-us&rs=en-us&ad=us) e di ripristinare le note da un [backup](https://support.microsoft.com/en-us/office/restore-notes-from-a-backup-5daf9cb0-6769-4998-a5de-f044fdd0d831?ui=en-us&rs=en-us&ad=us) alle nuove sottoscrizioni.