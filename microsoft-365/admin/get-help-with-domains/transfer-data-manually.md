...
description: Informazioni su come trasferire manualmente i dati tra due account di Microsoft 365 quando si modifica il piano o il nome della società o si combinano più sottoscrizioni in uno.
ms.openlocfilehash: b7b0bb9c9b95b31d98040ae90632ef87a7fb0e3b
ms.sourcegitcommit: 628f195cbe3c00910f7350d8b09997a675dde989
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 10/21/2020
ms.locfileid: "48645144"
---
...
> [!CAUTION]
> Durante il processo ci saranno tempi di in cui la posta elettronica, Skype for Business e un sito Web pubblico ospitato in Microsoft 365 non funzionano. Gli utenti riceveranno nuovi nomi utente e nuove password e dovranno reimpostare Outlook.
...
|Annullare l'abbonamento per il piano con cui si è fatto chiamando il supporto tecnico Microsoft per Microsoft 365.  <br/> | Verificare che il nuovo abbonamento funzioni e che tutti i dati siano stati trasferiti.  <br/>  [Contattare il supporto tecnico per](../contact-support-for-business-products.md) annullare l'abbonamento precedente.  <br/> |
...
Se si trasferiscono dati da Microsoft 365 a Microsoft 365 Midsize Business o Microsoft 365 Enterprise, le pagine di amministrazione sono strutturate in modo diverso. Guardare un [video: Introduzione a Microsoft 365 Enterprise](https://docs.microsoft.com/microsoft-365/admin/)e passare alle posizioni seguenti per esaminare le impostazioni di amministrazione.
  
Per Microsoft 365 Enterprise e Microsoft 365 Midsize Business:
  
|**Posizione**|**Scopo**|
|:-----|:-----|
|**Amministratore** \> **Microsoft 365** \> **Impostazioni del servizio** <br/> |Selezionare ogni scheda per le impostazioni per posta, siti, Lync, software utente, password, community, rights management e dispositivi mobili.  <br/> |
...
- Per salvare il contenuto di una raccolta documenti o di un elenco da un ambiente SharePoint Online (OneDrive for Business o siti del team) in condivisioni file o in un computer locale, vedere Informazioni sulla migrazione manuale del contenuto di [SharePoint Online.](https://support.microsoft.com/kb/2783484)
...
Chiedere agli utenti di copiare/sincronizzare il contenuto di [OneDrive for Business](https://support.microsoft.com/office/59b1de2b-519e-4d3a-8f45-51647cf291cd)nel computer e quindi aggiungerlo nuovamente al nuovo abbonamento.

### <a name="onenote"></a>OneNote 

Chiedere agli utenti [di eseguire il backup di OneNote](https://support.microsoft.com/office/back-up-notes-f58b34b0-611d-435e-87fa-7942a1767af4?ui=en-us&rs=en-us&ad=us) e di ripristinare le note da un [backup](https://support.microsoft.com/en-us/office/restore-notes-from-a-backup-5daf9cb0-6769-4998-a5de-f044fdd0d831?ui=en-us&rs=en-us&ad=us) ai nuovi abbonamenti.
