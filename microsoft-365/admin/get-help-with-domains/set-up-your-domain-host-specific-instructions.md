...
Per iniziare a utilizzare un dominio personalizzato (contoso.com) con Microsoft 365, è necessario verificare il dominio e configurare i record DNS del dominio. 
...
## <a name="let-microsoft-365-manage-your-dns-records"></a>Consenti a Microsoft 365 di gestire i record DNS
...
In alternativa, informazioni su come [modificare i server dei nomi per configurare Microsoft 365 con qualsiasi registrar](change-nameservers-at-any-domain-registrar.md).
