...
3. Aggiornare le informazioni dell'organizzazione, quindi selezionare **Salva modifiche**. Assicurati di compilare tutti i campi obbligatori contrassegnati con * per consentire il salvataggio delle modifiche.
...
5. Modificare l'indirizzo nella **casella Posta elettronica** alternativa, quindi selezionare **Avanti.**

6. Immettere il codice inviato all'indirizzo di posta elettronica alternativo e selezionare **OK** per verificare la modifica.
Per informazioni sulla modifica di altre informazioni del profilo, vedere [Modificare le preferenze di contatto](change-contact-preferences.md) o Modificare la lingua di [visualizzazione.](https://support.microsoft.com/office/6f238bff-5252-441e-b32b-655d5d85d15b.aspx)
