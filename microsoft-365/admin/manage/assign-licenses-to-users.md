...
2. Selezionare un prodotto per cui si vogliono assegnare le licenze.
...
2. Nel riquadro destro selezionare o deselezionare le app e i servizi per i quali si desidera consentire o rimuovere l'accesso.
3. Al termine, selezionare **Salva**, quindi selezionare **Chiudi**.

::: moniker-end

## <a name="assign-licenses-to-multiple-users-on-the-active-users-page"></a>Assegnare licenze a più utenti nella pagina Utenti attivi
...
5. Nel riquadro **Aggiungi a prodotti esistenti** impostare sulla posizione **Attivata** l'interruttore relativo alla licenza che si desidera assegnare agli utenti.

    Per impostazione predefinita, tutti i servizi associati a tali licenze vengono automaticamente assegnati agli utenti. È possibile limitare i servizi disponibili per gli utenti. Impostare sulla posizione **Disattivata** gli interruttori relativi ai servizi che non si desidera assegnare agli utenti.
...
## <a name="assign-licenses-to-one-user-on-the-active-users-page"></a>Assegnare licenze a un utente nella pagina Utenti attivi

::: moniker range="o365-worldwide"

1. Nell'interfaccia di amministrazione passare alla pagina **Utenti** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">Utenti attivi</a>.

2. Nella pagina **Utenti attivi** selezionare la riga dell'utente al quale si desidera assegnare una licenza.
...
4. Nel riquadro **Licenze di prodotto** impostare sulla posizione **Attivata** l'interruttore relativo alla licenza da assegnare all'utente.
    ...
    Per impostazione predefinita, tutti i servizi associati alla licenza vengono automaticamente assegnati all'utente. È possibile limitare i servizi disponibili per l'utente. Impostare sulla posizione **Disattivata** gli interruttori relativi ai servizi che non si desidera assegnare all'utente.
...
## <a name="move-users-to-a-different-subscription"></a>Spostare gli utenti su un abbonamento diverso

Se si hanno più abbonamenti e occorre cambiare abbonamento per alcuni utenti che hanno già una licenza per un abbonamento diverso, è possibile sostituire la licenza esistente con un'altra.

::: moniker range="o365-worldwide"

1. Nell'interfaccia di amministrazione passare alla pagina **Utenti** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">Utenti attivi</a>.

2. Selezionare i cerchi accanto ai nomi degli utenti per i quali si vogliono sostituire le licenze esistenti.

3. Nella parte superiore selezionare **Altre opzioni (...)**, quindi selezionare **Gestisci licenze prodotto**.

4. Nel riquadro **Gestisci licenze prodotto** selezionare **Sostituisci assegnazioni licenze di prodotto esistenti** \> **Avanti**.

5. Impostare sulla posizione **Attivata** l'interruttore relativo alle licenze da assegnare agli utenti.

    È possibile limitare i servizi disponibili per gli utenti. Impostare sulla posizione **Disattivata** gli interruttori relativi ai servizi che non si desidera assegnare agli utenti. Le eventuali licenze precedentemente assegnate agli utenti selezionati vengono rimosse.
...
6. Nella parte inferiore del riquadro **Sostituisci prodotti esistenti** selezionare **Sostituisci** \> **Chiudi** \> **Chiudi**.
...
## <a name="what-you-need-to-know-about-assigning-licenses-to-users"></a>Informazioni utili sull'assegnazione di licenze agli utenti
...
- Usare questa procedura per aggiungere una licenza a un account utente esistente. [Come aggiungere un account utente e al contempo assegnargli una licenza](../add-users/add-users.md).
...
[Informazioni su abbonamenti e licenze](../../commerce/licenses/subscriptions-and-licenses.md)

[Risolvere i conflitti di licenza in Office 365 per le aziende](resolve-license-conflicts.md)
...
[Acquistare le licenze per l'abbonamento](../../commerce/licenses/buy-licenses.md)