...
description: Informazioni su come assegnare licenze agli utenti o trasferire gli utenti a un nuovo abbonamento.
ms.openlocfilehash: da4dc2478180716710552ac1d4b7b81d019a622f
ms.sourcegitcommit: 2d59b24b877487f3b84aefdc7b1e200a21009999
ms.translationtype: HT
ms.contentlocale: it-IT
ms.lasthandoff: 05/27/2020
ms.locfileid: "44399837"
---
...
Nella pagina **Licenze** si assegnano licenze di un prodotto specifico a un massimo di 20 utenti. Nella pagina **Licenze** viene visualizzato un elenco di tutti i prodotti di cui si ha un abbonamento, il totale di licenze per ogni prodotto, il numero di licenze assegnate e il numero di quelle disponibili.
...
2. Selezionare i cerchi accanto ai nomi degli utenti di cui si vogliono sostituire le licenze esistenti.
...
5. Impostare sulla posizione **Attivata** l'interruttore relativo alle licenze da assegnare agli utenti.
    ...
    È possibile porre limiti ai servizi disponibili agli utenti. Impostare sulla posizione **Disattivata** gli interruttori relativi ai servizi che non si desidera assegnare agli utenti. Le eventuali licenze precedentemente assegnate agli utenti selezionati vengono rimosse.
...
2. Selezionare le caselle accanto ai nomi degli utenti di cui si vogliono sostituire le licenze esistenti.
...
[Risolvere i conflitti di licenza in Microsoft 365 per le aziende](resolve-license-conflicts.md)
