...
|Perché non è possibile visualizzare un messaggio che si trovava in precedenza? <br/> |Per gestire il numero di messaggi all'interno del centro messaggi, ogni messaggio scadrà e verrà rimosso dopo un determinato periodo di tempo. In generale, i messaggi scadono 30 giorni dopo il periodo di tempo indicato nel corpo del messaggio. <br/> |
