...
---
# <a name="office-365-user-email-settings"></a>Impostazioni di posta elettronica dell'utente di Office 365

L'amministratore di un'organizzazione di Office 365 può gestire le impostazioni di posta elettronica per gli utenti. Questo articolo fornisce informazioni sulla gestione di tali impostazioni.

## <a name="summary-of-email-settings"></a>Riepilogo delle impostazioni di posta elettronica

Questa tabella illustra le varie impostazioni di posta elettronica che è possibile modificare per un utente in Office 365.
...
|App di posta elettronica<sup>1</sup>| App di posta elettronica consente di scegliere le app che un utente può usare per accedere alla propria posta elettronica di Office 365. |
