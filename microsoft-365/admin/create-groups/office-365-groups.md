...
Se si preferisce un modo più automatico per gestire il ciclo di vita dei gruppi di Office 365, è possibile utilizzare i criteri di scadenza per scadere i gruppi a un intervallo di tempo specifico. I proprietari del gruppo riceveranno un messaggio di posta elettronica di 30, 15 e 1 giorni prima della scadenza del gruppo che consente di rinnovare facilmente il gruppo, se necessario. Vedere: [criteri di scadenza del gruppo di Office 365](office-365-groups-expiration-policy.md).
...
## <a name="which-office-365-plans-include-groups"></a>Quali piani di Office 365 includono gruppi?
...
[Informazioni su Gruppi di Office 365](https://support.office.com/article/learn-about-office-365-groups-b565caa1-5c40-40ef-9915-60fdb2d97fa2)

[Aggiornare le liste di distribuzione a gruppi di Office 365](../manage/upgrade-distribution-lists.md)

[Gestire Gruppi di Office 365 con PowerShell](https://docs.microsoft.com/office365/enterprise/powershell/manage-office-365-groups-with-powershell)
