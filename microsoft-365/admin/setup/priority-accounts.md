...
Come amministratore di un'organizzazione Microsoft 365, è ora possibile monitorare i messaggi di posta elettronica non riusciti o in ritardo inviati agli utenti che hanno un impatto aziendale elevato, come il CEO. È possibile abilitarla aggiungendo gli utenti all'elenco degli account prioritari. Gli account prioritari sono account essenziali per l'esecuzione dell'organizzazione. Aggiungere dirigenti, dirigenti, Manager o altri utenti che hanno accesso a informazioni sensibili o ad alta priorità.

## <a name="access-priority-accounts"></a>Accedere agli account prioritari

La funzionalità degli account di priorità descritta in questo argomento è disponibile solo per le organizzazioni che soddisfano entrambi i requisiti seguenti:
...
## <a name="monitor-your-priority-accounts"></a>Monitorare gli account prioritari

È possibile monitorare lo stato della posta elettronica degli account prioritari nell'interfaccia di amministrazione di Microsoft 365 nella pagina di **installazione** . È possibile monitorare attivamente fino a 250 account.

1. Passare all'interfaccia di amministrazione all'indirizzo <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">https://admin.microsoft.com</a>.

2. Selezionare **Setup** e scegliere **View** Next to **Premium Monitoring** per visualizzare lo stato degli account prioritari.

## <a name="email-issues-for-priority-accounts"></a>Problemi di posta elettronica per gli account prioritari

È possibile monitorare i problemi di posta elettronica per gli account di priorità accedendo al rapporto **problemi di posta elettronica per gli account di priorità** nell'interfaccia di amministrazione di Exchange. Per altre informazioni, vedere [i problemi di posta elettronica per gli account prioritari](https://review.docs.microsoft.com/en-us/Exchange/mail-flow-best-practices/mail-flow-insights/mfi-email-issues-for-priority-accounts?branch=Priority-chrisda).
