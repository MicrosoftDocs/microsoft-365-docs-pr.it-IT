...
- Elenco di persone che si desidera aggiungere a Microsoft 365. Anche se sono già stati aggiunti a Microsoft 365, se si stanno aggiornando le informazioni di dominio, è necessario immettere i relativi nomi qui.
...
- **Si desidera spostare l'organizzazione in Microsoft 365 contemporaneamente?** In tal caso, pianificare subito lo spostamento del dominio in Microsoft 365. Iniziare eseguendo l'installazione guidata di Microsoft 365; verrà richiesto di configurare il dominio.

- **Si desidera passare gradualmente a Microsoft 365?** Se si desidera passare a Microsoft 365 in più fasi, ignorare l'esecuzione della configurazione guidata di Microsoft 365 e prendere in considerazione l'adozione delle funzionalità di Microsoft 365 nell'ordine seguente:
    ...
    3. [Configurare Microsoft Teams da](#plan-for-teams) utilizzare per le riunioni.

    4. [Spostare il contenuto nell'archiviazione cloud di Microsoft 365](set-up-file-storage-and-sharing.md) (onedrive o siti del team di SharePoint).
...
Se si desidera utilizzare Microsoft 365 per la posta elettronica:
...
Se si desidera utilizzare Microsoft 365 per l'account di posta elettronica, è possibile portare con te la posta elettronica, i contatti e il calendario esistenti. La **pagina Configurazione** consente di spostare la posta elettronica e i contatti esistenti per la maggior parte degli scenari. Sono anche disponibili guide dettagliate per spostare una o più cassette postali.
...
|Molte  <br/> |Se si esegue la migrazione da Gmail, vedere [Migrate G Suite mailboxes to Microsoft 365](/Exchange/mailbox-migration/migrating-imap-mailboxes/migrate-g-suite-mailboxes).  <br/> Se si esegue la migrazione da un altro provider di posta elettronica, incluso Exchange, vedere Modi per eseguire la migrazione di più account di posta [elettronica a Microsoft 365.](/Exchange/mailbox-migration/mailbox-migration)  <br/> |

## <a name="plan-for-file-storage-and-migration"></a>Pianificare l'archiviazione di file e la migrazione

Microsoft 365 fornisce spazio di archiviazione cloud per singoli utenti, piccole organizzazioni e aziende. Per informazioni su cosa archiviare dove archiviare i documenti, vedere [Dove è possibile archiviare i documenti in Microsoft 365.](https://support.microsoft.com/office/c7c20284-bc94-47f4-9728-d28e9daf0790)
...
- **Si vuole eseguire l'integrazione con Active Directory locale?** È possibile integrare Active Directory locale con Microsoft 365 usando Azure Active Directory Connect. Per istruzioni, vedere [Configurare la sincronizzazione della directory per Microsoft 365.](../../enterprise/set-up-directory-synchronization.md)
  
- **Si desidera integrare Microsoft 365 con il software prodotto da altre società?** Se è necessario integrare Microsoft 365 con altri software dell'organizzazione, è consigliabile prendere in considerazione l'assunzione di un [partner](https://go.microsoft.com/fwlink/?linkid=391089) per facilitare la distribuzione.
...
- **Se si hanno meno di 50 dipendenti:**
  ...
  - **Chiama [il supporto di Microsoft 365 per le aziende](../contact-support-for-business-products.md) con le tue domande.** Microsoft è sempre pronta a offrire supporto. 
  - **Valutare se affidarsi a un [partner Microsoft](https://go.microsoft.com/fwlink/?linkid=391089)**. Se si ha poco tempo o si hanno requisiti avanzati (ad esempio, lo spostamento di migliaia di file nell'archiviazione cloud di Microsoft 365 o l'integrazione con altro software), un partner esperto può essere di grande aiuto. 
