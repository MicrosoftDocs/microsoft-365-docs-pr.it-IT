...
Dispositivi mobili e sicurezza di Microsoft 365 ospitati dal servizio Intune funzionano con la maggior parte dei dispositivi mobili, ma non con tutti. I seguenti sono supportati con Dispositivi mobili e sicurezza di base:The following are supported with Basic Mobility and Security:
...
Il Portale aziendale Intune consente a un dispositivo di essere gestito da Microsoft 365 dispositivi mobili e sicurezza di base.
...
Per connettere e configurare il telefono o il tablet iOS con il portale aziendale Office 365, vedi Configurare l'accesso dei dispositivi iOS alle [risorse aziendali.](/mem/intune/user-help/enroll-your-device-in-intune-ios)
...
Per connettere e configurare il telefono o il tablet Android con il portale aziendale Microsoft 365, vedi [Registrare](/mem/intune/user-help/enroll-device-android-company-portal)il dispositivo con Portale aziendale .

### <a name="windows-81-and-windows-10"></a>Windows 8.1 e Windows 10

Passare al Microsoft Store e scaricare e installare Portale aziendale Intune

Per connettere e configurare il telefono Windows o il PC con il portale aziendale per Microsoft 365, vedere Windows registrazione dei dispositivi [in Portale aziendale Intune](/intune-user-help/windows-enrollment-company-portal).

## <a name="next-steps"></a>Passaggi successivi

Dopo aver registrato il dispositivo in Dispositivi mobili e sicurezza di base, puoi iniziare a usare le app di Office sul dispositivo per lavorare con posta elettronica, calendario, contatti e documenti.