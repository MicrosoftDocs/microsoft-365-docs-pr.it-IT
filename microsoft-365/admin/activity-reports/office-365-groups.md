...
2. Nell'elenco **a discesa selezionare un report** selezionare **attività di gruppi**di **Office 365** \> .
...
|8.  <br/> |È possibile filtrare la serie visualizzata nel grafico selezionando un elemento nella legenda. Ad esempio, nel grafico **gruppi** **selezionare il numero totale** o **Active** ![attivo totale e attivo di gruppi](../../media/8eebd496-5955-4419-8d53-5f3ba1ad1c88.png) per visualizzare solo le informazioni relative a ognuna di esse. La modifica di questa selezione non modifica le informazioni nella tabella della griglia.  <br/> |
