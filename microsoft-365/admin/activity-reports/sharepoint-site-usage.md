...
> Nota: è necessario essere un amministratore globale, un lettore globale o un lettore di report in Microsoft 365 o un amministratore di Exchange, SharePoint o Skype for business per visualizzare i report. 
...
|3.  <br/> |Il grafico **Siti** mostra il numero totale dei siti e di quelli attivi. Qualsiasi sito in cui gli utenti hanno visualizzato, modificato, caricato, scaricato, condiviso o sincronizzato un file o visualizzato una pagina nel periodo di riferimento del report.  <br/> |
