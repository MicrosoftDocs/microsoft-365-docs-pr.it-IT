...
|Data ultima attività (UTC)  <br/> |Data più recente in cui è stata eseguita un'attività di file nell'account OneDrive per l'intervallo di date selezionato. . Per visualizzare l'attività relativa a una data specifica, selezionare la data direttamente nel grafico.  <br/> |
|File visualizzati o modificati  <br/> |Numero di file caricati, scaricati, modificati o visualizzati dall'utente.   <br/> |
|File sincronizzati  <br/> |Numero di file sincronizzati dal dispositivo locale di un utente all'account OneDrive. <br/> |
