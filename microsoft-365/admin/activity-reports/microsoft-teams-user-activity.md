...
2. Nell'elenco **a discesa selezionare un report** selezionare attività utente di **Microsoft teams** \> .
...
|3.  <br/> |Per garantire la qualità dei dati, vengono eseguiti i controlli giornalieri di convalida dei dati per gli ultimi cinque giorni e verranno rilevati eventuali vuoti. Durante il processo, è possibile notare differenze nei dati cronologici.  <br/> |
...
|6.  <br/> | Nel grafico **attività** , l'asse Y è il numero di attività specificate.  <br/>  Nel grafico **file** l'asse Y indica il numero di utenti che partecipano a chat di teams, chat private, chiamate o riunioni.  <br/>  L'asse X nei grafici rappresenta l'intervallo di date selezionato per il report specifico.  <br/> |
