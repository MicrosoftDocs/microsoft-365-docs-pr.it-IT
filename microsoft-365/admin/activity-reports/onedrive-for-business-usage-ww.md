...
|:-----|:-----|
|**Metrica**|**Definizione**|
|URL  <br/> |L'indirizzo Web del OneDrive dell'utente. <br/> |
...
|Data ultima attività (UTC)  <br/> | La data più recente in cui è stata eseguita un'attività su file in OneDrive. Se in OneDrive non ci sono state attività sui file, il valore sarà vuoto.  <br/> |
