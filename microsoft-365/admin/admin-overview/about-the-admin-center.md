...
ms.locfileid: "43623977"
---
# <a name="about-the-microsoft-365-admin-center"></a>Informazioni sull'interfaccia di amministrazione di Microsoft 365

**Se si è acquistato un piano Microsoft 365 for business e si dispone di autorizzazioni di amministratore, è possibile accedere all'interfaccia di amministrazione**. Questo articolo contiene tutte le informazioni necessarie.

**Se si è un utente o si dispone di un piano per la famiglia Microsoft 365, non si dispone di un centro di amministrazione.** Per configurare Microsoft 365, andare a [scaricare e installare o reinstallare microsoft 365 o Office 2019 su un PC o Mac](https://support.office.com/article/4414eaaf-0478-48be-9c42-23adc4716658.aspx).
...
2. Selezionare l'icona di avvio delle app in alto a sinistra e scegliere **Amministratore**.
    ...
    Il riquadro **amministratore** viene visualizzato solo per gli utenti che dispongono di [autorizzazioni di amministratore](../add-users/about-admin-roles.md)Microsoft 365. Se il riquadro non è visibile, non si dispone delle autorizzazioni per accedere all'interfaccia di amministrazione per l'organizzazione.
...
|**Report** <br/> |Vedere a colpo d'occhio il modo in cui l'organizzazione utilizza Microsoft 365 con relazioni dettagliate sull'utilizzo della posta elettronica, le attivazioni di Office e altro ancora. Informazioni su come utilizzare i nuovi [rapporti attività](../activity-reports/activity-reports.md).<br/> |
