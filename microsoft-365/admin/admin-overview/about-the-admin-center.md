...
**Se è stato acquistato un Microsoft 365 per il business plan E si dispone delle autorizzazioni di amministratore, è possibile accedere all'interfaccia di amministrazione**. Questo articolo contiene tutte le informazioni necessarie.

**Se sei un utente o hai un piano Microsoft 365 Family, non hai un'interfaccia di amministrazione.** Per configurare Microsoft 365, passare [a Scaricare e installare o reinstallare Microsoft 365 o Office 2019 in un PC o Mac](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658).
...
2. Selezionare l'icona di avvio delle app in alto a sinistra e scegliere **Amministratore**.
    ...
    Il **riquadro Amministratore** viene visualizzato solo per gli utenti che hanno Microsoft 365 autorizzazioni di [amministratore](../add-users/about-admin-roles.md). Se il riquadro non è visibile, non si hanno le autorizzazioni necessarie per accedere all'interfaccia di amministrazione per l'organizzazione.
...
|**Report** <br/> |Scopri a colpo d'occhio come l'organizzazione sta usando Microsoft 365 report dettagliati sull'uso della posta elettronica, Office attivazioni e altro ancora. Vedere come si usano i nuovi [report attività](../activity-reports/activity-reports.md).  <br/> |
|**Integrità** <br/> |Visualizza la salute a colpo d'occhio. Puoi anche controllare maggiori dettagli e la cronologia della salute. Per [ulteriori informazioni, vedere Come controllare](../../enterprise/view-service-health.md) [l'integrità del servizio Windows'integrità del](/windows/deployment/update/check-release-health) rilascio.  <br/><br/>Usare il Centro messaggi per tenersi aggiornati sulle imminenti modifiche a funzionalità e servizi. Vengono pubblicati annunci con informazioni utili per prepararsi al cambiamento e comprendere l'impatto che può avere sugli utenti. Ulteriori dettagli sono in [Centro messaggi](../manage/message-center.md). <br/> |
...
- Gestire gli utenti: [aggiungere utenti e assegnare licenze contemporaneamente](../add-users/add-users.md), [Eliminare o ripristinare utenti](../add-users/delete-a-user.md)o [Reimpostare la password di un utente](../add-users/reset-passwords.md).
