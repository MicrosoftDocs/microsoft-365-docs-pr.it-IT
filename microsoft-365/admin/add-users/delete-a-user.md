...
description: Informazioni su come eliminare un account utente. Decidi cosa fare con la posta elettronica e il contenuto OneDrive'utente. E decidi se mantenere la licenza del prodotto o smettere di pagarla.
ms.openlocfilehash: f4b1e0b1fb591d369cc09010db86dd995d7d4896
ms.sourcegitcommit: f780de91bc00caeb1598781e0076106c76234bad
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 05/19/2021
ms.locfileid: "52535975"
---
...
- Se si dispone di una sottoscrizione Enterprise come Office 365 Enterprise E3, è possibile conservare i dati della cassetta postale di un account utente eliminato trasformandolo in una cassetta postale *inattiva.* Per saperne di più, vedere [Gestire le cassette postali inattive in Exchange Online](../../compliance/inactive-mailboxes-in-office-365.md).

## <a name="global-admin-delete-a-user-stop-paying-for-their-license-and-choose-what-to-do-with-their-email-and-onedrive-content"></a>Amministratore globale: eliminare un utente, interrompere il pagamento della licenza e scegliere cosa fare con la posta elettronica e OneDrive contenuto

Se si è un amministratore globale, quando si elimina un utente è anche possibile concedere a un altro utente l'accesso alla posta elettronica e scegliere cosa fare con il OneDrive contenuto.

### <a name="things-to-consider"></a>Osservazioni

Prima di iniziare, pensa a cosa vuoi fare con la posta elettronica e il contenuto OneDrive dell'utente e se vuoi mantenere la licenza o smettere di pagarla.
...
|OneDrive contenuto  <br/> |Se l'utente ha salvato i propri file OneDrive, è possibile concedere a un altro utente l'accesso a tali file.  <br/><br/> Dovrai spostare i file che vuoi mantenere entro il periodo di conservazione impostato per OneDrive file. **Per impostazione predefinita, il periodo di conservazione è 30 giorni.** Se non si spostano i file entro il periodo di conservazione dopo l'eliminazione dell'utente, il contenuto OneDrive verrà eliminato definitivamente. Per aumentare il numero di giorni di conservazione dei OneDrive per gli account eliminati, vedere Set the OneDrive [retention for deleted users](/onedrive/set-retention).  <br/><br/> **Importante!** Se l'utente eliminato ha utilizzato un personal computer per scaricare i file da SharePoint e OneDrive, non è possibile cancellare i file archiviati nel computer. Continueranno ad avere accesso ai file sincronizzati da OneDrive.           |
...
- **Non si hanno le autorizzazioni appropriate per eliminare un utente**. Solo gli utenti che [Microsoft 365 amministratori globali](about-admin-roles.md) o amministratori di gestione utenti possono eliminare gli utenti. Si tratta in genere del supporto tecnico dell'istituto di istruzione o dell'azienda.
...
**Si desidera eliminare i Microsoft 365 dal computer? Passare a [Annulla l'abbonamento](../../commerce/subscriptions/cancel-your-subscription.md).**
