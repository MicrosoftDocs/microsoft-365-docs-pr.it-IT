...
OneDrive |Azure Active Directory Single Sign-on è abilitato per gli utenti al primo accesso a OneDrive.<br><br>È incluso il reindirizzamento delle cartelle note per le cartelle "desktop", "documento" e "immagini"; abilitata e configurata da Microsoft Managed Desktop.
...
Microsoft Defender per endpoint |    Microsoft Managed Desktop utilizza questo strumento per monitorare la sicurezza dei dispositivi. 
