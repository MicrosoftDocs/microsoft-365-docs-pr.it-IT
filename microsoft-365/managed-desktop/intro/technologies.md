...
[Microsoft Defender per Endpoint | Riduzione della superficie di attacco](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/attack-surface-reduction) | La riduzione della superficie di attacco si rivolge a comportamenti software rischiosi spesso utilizzati in modo improprio da utenti malintenzionati.
