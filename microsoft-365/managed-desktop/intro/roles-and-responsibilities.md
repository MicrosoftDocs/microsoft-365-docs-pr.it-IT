...
App | Microsoft fornirà indicazioni sulla distribuzione per le applicazioni approvate che utilizzano Intune su richiesta.<br><br>Il cliente è responsabile per:<br>-Fornire un elenco di app per la propria organizzazione (al di fuori delle app di Office 365)<br>Gestione delle licenze per le app<br>– Avente il tipo e la quantità di licenze giusti<br>-Assegnazione delle app<br>– Assegnazione delle app ai gruppi di utenti di Azure AD<br>-Aggiornamenti delle app<br>– Monitoraggio, creazione di pacchetti e distribuzione delle funzionalità e degli aggiornamenti della sicurezza delle app<br>-Test dell'applicazione utente (UAT)<br>-Fornire un pacchetto di distribuzione appropriato<br><br>Per ulteriori informazioni, vedere [app](../get-ready/apps.md)
