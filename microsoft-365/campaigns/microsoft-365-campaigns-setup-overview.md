...
Per il personale chiave, ti consigliamo di usare [i dispositivi gestiti per](../business/set-up-windows-devices.md?toc=/microsoft-365/campaigns/toc.json) una protezione ancora migliore. Per tutti i dispositivi, è necessario configurare l'autenticazione [a più fattori.](m365-campaigns-multifactor-authenication.md)
3. Tutti gli utenti dovrebbero imparare a proteggere se stessi e la campagna imparando a [conoscere il phishing e altri attacchi.](m365-campaigns-phishing-and-attacks.md) Questa [infografica](m365-campaigns-protect-campaign-infographic.md) può anche aiutare gli utenti a comprendere come proteggere la campagna dalle minacce online.
