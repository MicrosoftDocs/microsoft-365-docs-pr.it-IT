...
I consigli sulla sicurezza per Microsoft 365 in questa soluzione rendono molto più difficile per gli hacker ottenere l'accesso all'ambiente. Il compromesso è che gli utenti dovranno essere consapevoli di come lavorare in questo ambiente più sicuro. Comprendiamo che è necessaria un po' di pazienza in più, ma vale la pena proteggere l'organizzazione.
...
- Verificare i messaggi di posta elettronica legittimi e cercare suggerimenti per la sicurezza da Advanced Phishing in Defender for Office 365 Protection.
...
- Installare le versioni più recenti delle app desktop di Office e mantenere aggiornate con gli aggiornamenti, quando richiesto.
...
| |**Windows 10**|**Mac**|
|:-----|:-----|:------|
|Funzionalità di sicurezza|Attivare la protezione dei dispositivi BitLocker<p><p> Assicurarsi Windows Defender che rimanga attivo <p>Attivare Windows Firewall| Usare FileVault per crittografare il disco Mac <p><p>Usare un software antivirus affidabile <p>Attivare la protezione firewall|
...
Consigliamo ai membri del personale più importanti di usare i dispositivi Windows 10 appena acquisiti che gestisci. Ti mostreremo come gestire [e proteggere questi dispositivi.](../business/set-up-windows-devices.md?toc=/microsoft-365/campaigns/toc.json) In questo modo si garantisce che i membri del personale che sono l'obiettivo di maggior valore per gli hacker ricevano la massima protezione.
