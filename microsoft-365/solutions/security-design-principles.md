---
title: Microsoft 365 Enterprise pianificazione delle risorse - Architettura di cybersecurity
description: Informazioni su come superare le sfide di sicurezza in Microsoft Enterprise architettura da Kozeta Garrett, Cybersecurity Architect di Microsoft.
ms.author: bcarter
author: brendacarter
manager: bcarter
ms.audience: ITPro
...
|[Microsoft 365 Responsabili della sicurezza per le decisioni aziendali](../security/Microsoft-365-security-for-bdm.md)    | Quando hai tempo per un piano più completo, questo articolo include consigli che si estendono su Microsoft 365, in base alla priorità in base alla superficie di attacco. Viene fornito anche con un foglio di calcolo che puoi usare per ordinare le licenze e l'area (ad esempio identità, protezione dalle minacce e monitoraggio).  |
