...
Per il livello di protezione dei dati sensibili si userà un'etichetta di riservatezza per classificare il team. Questa etichetta può essere usata anche per classificare e singoli file in questo o in altri team o in altre posizioni dei file, ad esempio SharePoint o OneDrive. 
...
L'ulteriore configurazione dello scenario dei dati sensibili è da eseguire nel sito di SharePoint associato al team, quindi il passaggio successivo consiste nel creare un team.
...
4. Nell'elenco **Riservatezza** scegliere l'etichetta **Dati sensibili** appena creata.
...
Per fare in modo che il sito di SharePoint non venga condiviso con persone che non fanno parte del team, limitiamo la condivisione ai proprietari.
