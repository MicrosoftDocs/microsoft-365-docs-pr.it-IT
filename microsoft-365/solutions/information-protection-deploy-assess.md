...
> [!NOTE]
> Per individuare le informazioni riservate presenti nei file archiviati in locale, vedere [Azure Information Protection](https://docs.microsoft.com/azure/information-protection/quickstart-findsensitiveinfo).
