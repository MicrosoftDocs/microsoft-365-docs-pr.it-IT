...
description: Informazioni su come distribuire servizi di protezione dalle minacce e funzionalità di sicurezza in Microsoft 365 E5.
ms.author: deniseb
author: denisebmsft
manager: dansimp
ms.audience: ITPro
...
Le soluzioni di sicurezza Microsoft sono integrate nei nostri prodotti e servizi. Le funzionalità di automazione e machine learning riducono il carico dei team di sicurezza per assicurarsi che gli elementi siano indirizzati. Inoltre, la forza delle soluzioni di sicurezza Microsoft si basa su trilioni di segnali che eserciteremo ogni giorno nel [nostro Intelligent Security Graph.](https://cloud-platform-assets.azurewebsites.net/intelligent-security-graph) Le soluzioni di sicurezza di Microsoft 365 includono [Microsoft 365 Defender,](../security/defender/microsoft-365-defender.md)una soluzione che riunisce i segnali attraverso la posta elettronica, i dati, i dispositivi e le identità per disegnare un'immagine delle minacce avanzate contro l'organizzazione.
...
Usare questo articolo come guida per l'implementazione della soluzione di protezione dalle minacce.
...
Non appena si distribuisce una delle funzionalità di Defender per Office 365, è possibile attivare Microsoft 365 Defender, che riunisce i segnali e i dati in un'unica posizione. 
...
|Microsoft Defender ATP    | Una piattaforma di endpoint protection che consente di prevenire, rilevare, analizzare e rispondere alle minacce avanzate.  Defender for Endpoint può richiedere del tempo per la distribuzione, ma la configurazione può essere eseguita in parallelo con altre funzionalità.   |
...
Per assicurarsi che l'organizzazione abbia la migliore protezione possibile, configurare e distribuire la soluzione di sicurezza in modo da includere i passaggi seguenti:
