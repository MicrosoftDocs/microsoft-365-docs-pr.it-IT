---
title: Configurare SharePoint come origine di contenuto didattico per Microsoft Viva Learning (anteprima)
ms.author: chucked
...
ms.locfileid: "53289944"
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="57325-103">Configurare SharePoint come origine di contenuto didattico per Microsoft Viva Learning (anteprima)</span><span class="sxs-lookup"><span data-stu-id="57325-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="57325-104">Questa funzionalità non è ancora disponibile nell'anteprima del prodotto.</span><span class="sxs-lookup"><span data-stu-id="57325-104">This feature is not yet available in product preview.</span></span>
