...
In questo articolo viene descritto come utilizzare le tecniche di minificazione e aggregazione con Web Essentials per ridurre il numero di richieste HTTP e ridurre il tempo necessario per caricare le pagine in SharePoint Online.
...
Per i file JavaScript e CSS, puoi anche usare un approccio denominato minification, in cui puoi ridurre le dimensioni totali dei file rimuovendo spazi vuoti e altri caratteri non necessari.
...
2. Fai clic con il pulsante destro del mouse sui file selezionati e scegli **Web Essentials** \> **Create JavaScript bundle file** dal menu di scelta rapida. Ad esempio: 
