...
2. Salvare il file sul desktop **comeGroupsAndPermissions.csv**.<br/>
...
```
<br/>Dove *tenant* è uguale al nome del tenant e *nomeutente* è uguale al nome utente di un utente esistente.<br/>

4. Salvare il file sul desktop **comeUsers.csv**.<br/>
