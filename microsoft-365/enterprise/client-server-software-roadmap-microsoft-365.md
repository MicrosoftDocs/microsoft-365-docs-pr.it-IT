...
ms.locfileid: "46691105"
---
# <a name="client-and-server-software-roadmap-for-microsoft-365"></a>Roadmap software client e server per Microsoft 365

La maggior parte delle organizzazioni dell'organizzazione dispone di un ambiente eterogeneo con più versioni di sistemi operativi, software client e server. Microsoft 365 per Enterprise include le versioni più sicure di questi componenti chiave dell'infrastruttura IT con caratteristiche di produttività progettate per sfruttare le tecnologie cloud.
...
- Server di Office installati nei server nei rispettivi servizi equivalenti in Microsoft 365
...
Microsoft 365 for Enterprise include Microsoft 365 Apps for Enterprise, una versione dei prodotti client di Office disponibile con una licenza Microsoft 365 per Enterprise ed è installata e aggiornata da Microsoft Cloud. Microsoft 365 Apps for enterprise include aggiornamenti della sicurezza e le funzionalità più recenti. Per saperne di più, consultare le [informazioni su Microsoft 365 Apps for enterprise](https://docs.microsoft.com/deployoffice/about-microsoft-365-apps).
...
3. Installazione di Microsoft 365 Apps for enterprise, singolarmente o in combinazione con un'implementazione IT. Per ulteriori informazioni, vedere [Deployment Guide for Microsoft 365 Apps](https://docs.microsoft.com/deployoffice/deployment-guide-microsoft-365-apps).
...
Per informazioni sulla migrazione di utenti e dati per carichi di lavoro specifici di Microsoft 365:

- Cassette postali degli utenti da Exchange Server a Exchange Online, vedere [Move Mailboxes Between on-premises and Exchange Online Organizations](https://docs.microsoft.com/exchange/hybrid-deployment/move-mailboxes).
- Dati di SharePoint da SharePoint Server a SharePoint Online, vedere [eseguire la migrazione del contenuto a Microsoft 365](https://docs.microsoft.com/sharepointmigration/migrate-to-sharepoint-online).
- Skype for business online per Microsoft teams, vedere la [Guida sulla migrazione e sull'interoperabilità](https://docs.microsoft.com/microsoftteams/migration-interop-guidance-for-teams-with-skype).
...
- [Guida sulla fine del supporto di Exchange 2007](exchange-2007-end-of-support.md)
- [Guida sulla fine del supporto di SharePoint Server 2007](sharepoint-2007-end-of-support.md)
- [Guida sulla fine del supporto di Project Server 2007](project-server-2007-end-of-support.md)
...
- [Guida sulla fine del supporto di PerformancePoint Server 2007](pps-2007-end-of-support.md)
...
1. Migrazione dei dati nei server di Office 2007 a Microsoft 365. Per ottenere assistenza, è necessario noleggiare un partner Microsoft.
...
1. Migrazione dei dati nei server di Office 2013 a Microsoft 365. Per informazioni in merito, vedere [FastTrack per Microsoft 365](https://fasttrack.microsoft.com/microsoft365) o assumere un partner Microsoft.
2. Presentare le nuove funzionalità e i processi di lavoro agli utenti.
...
1. Migrazione dei dati nei server di Office 2016 a Microsoft 365. Per informazioni in merito, vedere [FastTrack per Microsoft 365](https://fasttrack.microsoft.com/microsoft365) o assumere un partner Microsoft.
2. Presentare le nuove funzionalità e i processi di lavoro agli utenti.
...
Il **14 gennaio 2020** Windows 7 ha raggiunto la fine del supporto. Per eseguire la migrazione dei dispositivi con sistema operativo Windows 7 o Windows 8.1, è possibile eseguire un aggiornamento sul posto. 
...
Questo poster di una pagina è un modo rapido per comprendere i diversi percorsi che è possibile eseguire per impedire che i prodotti client e server di Office 2010 e Windows 7 raggiungano la fine del supporto, con percorsi preferiti e il supporto per le destinazioni risultanti in Microsoft 365 per Enterprise evidenziato.

È possibile [scaricare il poster](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/Office2010Windows7EndOfSupport.pdf) e stamparlo in formato lettera, legale o tabloid (27,9 x 43,2 cm).

## <a name="transition-your-entire-organization"></a>Transizione dell'intera organizzazione

Per ottenere un'immagine migliore di come spostare l'intera organizzazione ai prodotti e ai servizi in Microsoft 365 per Enterprise, vedere il [poster di transizione](../downloads/transition-org-to-m365.pdf).
...
È possibile [scaricare il poster](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/transition-org-to-m365.pdf) e stamparlo in formato lettera, legale o tabloid (27,9 x 43,2 cm).

## <a name="how-microsoft-does-microsoft-365-for-enterprise"></a>Come Microsoft fa Microsoft 365 per Enterprise

Vedere in che modo gli esperti IT di Microsoft hanno eseguito la migrazione della società a Microsoft 365 per Enterprise con queste risorse: 
