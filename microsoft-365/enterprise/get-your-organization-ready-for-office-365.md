...
- Supporto per i client
  ...
  Include l'autenticazione basata su certificati, la gestione dei dispositivi mobili, le opzioni di autenticazione e la collaborazione tra tenant. Per ulteriori informazioni, accedere all' [autenticazione basata su certificato](microsoft-365-client-support-certificate-based-authentication.md) .
...
È inoltre possibile accedere alla sottoscrizione Microsoft 365 e utilizzare le [guide di installazione per microsoft 365 e i servizi di Office 365](setup-guides-for-microsoft-365.md).
