...
#### [Passaggio 2: proteggere le identità privilegiate](identity-designate-protect-admin-accounts.md)
...
#### [Passaggio 6: utilizzare i gruppi per semplificare la gestione](identity-self-service-group-management.md)
...
#### [Identità e accesso ai dispositivi](identity-device-access-m365-test-environment.md)
##### [Solo cloud](cloud-only-prereqs-m365-test-environment.md)
##### [Sincronizzazione hash delle password (pH)](phs-prereqs-m365-test-environment.md)
##### [Autenticazione pass-through (PTA)](pta-prereqs-m365-test-environment.md)
...
#### [Criteri di conformità del dispositivo](mam-policies-for-your-microsoft-365-enterprise-dev-test-environment.md)
