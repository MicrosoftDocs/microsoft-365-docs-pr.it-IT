...
È possibile utilizzare PowerShell per Microsoft 365 come alternativa all'interfaccia di amministrazione di Microsoft 365 per gestire le password in Microsoft 365. 
...
```
### <a name="force-a-user-to-change-their-password"></a>Forzare la modifica della password di un utente

Utilizzare questi comandi per impostare una password e forzare la modifica della nuova password da un utente.
...
Utilizzare questi comandi per impostare una password e imporre a un utente di modificare la nuova password al successivo accesso.
...
Utilizzare questi comandi per forzare la modifica della password da un utente.
