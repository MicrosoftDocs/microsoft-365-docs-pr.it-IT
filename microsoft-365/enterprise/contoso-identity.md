...
Contoso ha creato un insieme di [criteri di accesso condizionale](../security/defender-365-security/identity-access-policies.md) per Azure AD e Intune per tre livelli di protezione:
