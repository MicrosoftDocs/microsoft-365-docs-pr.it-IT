...
- [**Account utente, licenze e gruppi**](manage-user-accounts-and-licenses-with-microsoft-365-powershell.md)
    ...
    Per informazioni sull'uso dei comandi di automazione per gestire account utente, licenze e gruppi, iniziare da qui.
...
- [**Exchange Online**](/powershell/exchange/exchange-online-powershell)
    ...
    Iniziare da qui se si desidera gestire Exchange Online.

- [**Migrazione della posta elettronica**](use-powershell-for-email-migration-to-microsoft-365.md)

    Iniziare da qui se si desidera eseguire la migrazione della posta elettronica da sistemi preesiste.

- [**Centro sicurezza e conformità**](/powershell/exchange/scc-powershell)

    Iniziare da qui se si desidera gestire le funzionalità del Centro sicurezza & conformità.
