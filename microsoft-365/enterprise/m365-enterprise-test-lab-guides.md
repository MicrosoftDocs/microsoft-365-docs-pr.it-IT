...
- [Sincronizzazione hash delle password](password-hash-sync-m365-ent-test-environment.md)
   ...
   Abilitare e testare la sincronizzazione della directory basata su hash delle password da un controller di dominio di Windows Server AD.

- [Autenticazione pass-through](pass-through-auth-m365-ent-test-environment.md)
  
   Abillitare e testare l'autenticazione pass-through per un controller di dominio di Windows Server AD.

- [Accesso Single Sign-On facile di Azure AD](single-sign-on-m365-ent-test-environment.md)
  
   Attivare e testare l'accesso Single Sign-On facile di Azure AD con un controller di dominio di Windows Server AD.
...
- [Gestione degli accessi con privilegi per l'ambiente di testing di Microsoft 365 Enterprise](privileged-access-microsoft-365-enterprise-dev-test-environment.md)
...
[Esperienza di Microsoft Cloud con le guide al lab di test di adozione del cloud](https://mva.microsoft.com/training-courses/experience-the-microsoft-cloud-with-cloud-adoption-test-lab-guides-17960?l=LXNRdhSLE_1000115881)
    
[Pila di Guide al lab di test di One Microsoft Cloud](http://aka.ms/catlgstack)
