...
- [La configurazione di base](lightweight-base-configuration-microsoft-365-enterprise.md)
    
    Creare una sottoscrizione di valutazione di Microsoft 365 Enterprise E5.

- [La configurazione di base per l'organizzazione simulata](simulated-ent-base-configuration-microsoft-365-enterprise.md)
...
Per ulteriori TLG che si applicano sia a Office 365 che a Microsoft 365, accedere a [guide di laboratorio di testing](m365-enterprise-test-lab-guides.md).  
