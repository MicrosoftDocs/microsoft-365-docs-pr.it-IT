...
Le nuove aree geografiche sono progettate per soddisfare le esigenze in evoluzione dei clienti tedeschi con maggiore flessibilità, i servizi cloud intelligenti più recenti e la connettività completa alla nostra rete cloud di servizi Microsoft 365 e alla residenza dei dati dei clienti in Germania.
...
I clienti esistenti di Microsoft Cloud Deutschland possono ora iniziare a eseguire la migrazione dei clienti di Office 365, Dynamics 365 Customer Engagement e Power Platform. Il primo passaggio consiste nel [consenso esplicito alla migrazione gestita da Microsoft](./ms-cloud-germany-migration-opt-in.md) nelle nuove aree data center tedesche.
...
La migrazione sposterà il tenant di Azure AD dal servizio Azure AD per la Germania sovrana all'istanza dei servizi di Office 365 di Azure AD nell'area DELL'UE.
...
I clienti Microsoft Cloud Deutschland esistenti possono ora iniziare a eseguire la migrazione dei servizi Office 365, Dynamics 365 Customer Engagement e Power Platform. Il primo passaggio consiste nel [consenso esplicito alla migrazione gestita da Microsoft](./ms-cloud-germany-migration-opt-in.md) nelle nuove aree data center tedesche. Quando si rinnova l'abbonamento, si acconsente automaticamente al consenso esplicito per una migrazione assistita da Microsoft. Microsoft invierà una notifica agli amministratori del tenant dei clienti tramite posta elettronica e nel Centro messaggi dell'interfaccia di amministrazione di Microsoft 365 quando si è verificato questo problema. Tuttavia, se si preferisce avviare il processo ora, è [possibile](./ms-cloud-germany-migration-opt-in.md) acconsentire esplicitamente direttamente nell'interfaccia di amministrazione di Microsoft 365 oggi stesso. Le migrazioni dovrebbero iniziare all'inizio del 2021 e verranno completate entro il 29 ottobre 2021. 
...
Il primo passaggio consiste nel notificare a Microsoft l'autorizzazione a eseguire la migrazione dell'abbonamento e dei dati da Microsoft Cloud Deutschland ai servizi di Office 365 nelle nuove aree data center tedesche. Per istruzioni, [fai](./ms-cloud-germany-migration-opt-in.md) riferimento al processo di consenso esplicito e tieni presente che:
...
- È consigliabile consultare la descrizione del servizio della piattaforma Office 365 per comprendere quali funzionalità e servizi saranno disponibili per l'organizzazione dopo la migrazione nell'area tedesca.
...
Microsoft offre la migrazione dei tenant di Office 365 da Microsoft Cloud Deutschland ai servizi di Office 365 nelle nuove aree data center tedesche senza costi aggiuntivi. Anche se ti consigliamo vivamente di acconsentire esplicitamente alla migrazione alle nuove aree data center tedesche, continueremo a fornire gli aggiornamenti della sicurezza necessari per l'area Microsoft Cloud Deutschland.
...
[Consenso esplicito](./ms-cloud-germany-migration-opt-in.md) alla migrazione gestita da Microsoft in data odierna. Quando siamo pronti per avviare la migrazione, ti informeremo tramite il Centro messaggi nell'interfaccia di amministrazione di Microsoft 365.

**Dynamics 365 e Power BI**

Acconsentire esplicitamente alla migrazione guidata da Microsoft per [Dynamics 365 Customer Engagement](/dynamics365/get-started/migrate-data-german-region) e Power [BI](/power-bi/admin/service-admin-migrate-data-germany) oggi. Quando saremo pronti per avviare la migrazione, forniremo informazioni tramite il Centro messaggi nell'interfaccia di amministrazione di Microsoft 365.

### <a name="will-the-price-change-for-the-office-365-services-that-i-use"></a>Il prezzo cambia per i servizi di Office 365 che uso?
...
Durante la migrazione da Microsoft Cloud Deutschland ai servizi di Office 365, le SKU specifiche del servizio germania vengono sostituite con versioni globali dello stesso SKU o simili. Per la maggior parte dei casi, lo SKU nei servizi di Office 365 è lo stesso, tuttavia esistono poche sostituzioni in cui la SKU in Germania non è più disponibile nei servizi di Office 365. Se si desidera aggiornare lo SKU assegnato all'organizzazione al termine della migrazione, contattare il venditore per aggiungere o modificare i servizi assegnati.
...
| Dynamics 365 Enterprise Edition - Archiviazione database \_ aggiuntiva DE (CRMSTORAGE \_ DE) | Dynamics 365 Enterprise Edition - Archiviazione database aggiuntiva (CRMSTORAGE) |
| Dynamics 365 Enterprise Edition - Istanza aggiuntiva non di produzione \_ DE (CRMTESTINSTANCE \_ DE) | Dynamics 365 Enterprise Edition - Istanza aggiuntiva non di produzione (CRMTESTINSTANCE) |
...
| Dynamics 365 for Team Members Enterprise Edition \_ DE (DYN365 \_ ENTERPRISE \_ TEAM \_ MEMBERS \_ DE) | Dynamics 365 for Team Members Enterprise Edition (MEMBRI DEL TEAM DYN365 \_ \_ \_ ENTERPRISE) |
...
| Exchange Online (Piano 1) DE \_ (EXCHANGESTANDARD \_ DE) | Exchange Online (Piano 1) (EXCHANGESTANDARD) |
...
| Office 365 A1 per docenti \_ DE (STANDARDWOFFPACK \_ FACULTY \_ DE) | Office 365 A1 per istituti di docente (FACOLTÀ STANDARDWOFFPACK) \_ |
| Office 365 A1 per studenti \_ DE (STANDARDWOFFPACK \_ STUDENT \_ DE) | Office 365 A1 per studenti (STANDARDWOFFPACK \_ STUDENT) |
| Office 365 Advanced Compliance \_ DE (EQUIVIO \_ ANALYTICS \_ DE) | Conformità di Microsoft 365 E5 (CONFORMITÀ DI INFORMATION \_ \_ PROTECTION) |
...
| Office 365 Extra File Storage \_ DE (SHAREPOINTSTORAGE \_ DE) | Archiviazione file extra di Office 365 (SHAREPOINTSTORAGE) |
| Office 365 F1 \_ DE (DESKLESSPACK \_ DE) | Office 365 F1 (DESKLESSPACK) |
| Office 365 ProPlus per faculty \_ DE (OFFICESUBSCRIPTION \_ FACULTY \_ DE) | Office 365 ProPlus for Faculty (OFFICESUBSCRIPTION \_ FACULTY) |
...
| Power BI Pro per docenti \_ DE (POWER \_ BI PRO \_ \_ FACULTY \_ DE) | Power BI Pro per istituti di docente (FACOLTÀ DI POWER \_ BI \_ \_ PRO) |
...
| SharePoint Online (Piano 1) DE \_ (SHAREPOINTSTANDARD \_ DE) | SharePoint Online (Piano 1) (SHAREPOINTSTANDARD) |
...
- Per Office 365, è possibile inviare domande utilizzando il collegamento Serve aiuto? dell'interfaccia di amministrazione di &quot; &quot; Microsoft [365.](https://portal.office.de/)
- Se si è clienti dynamics 365 Customer Engagement e Power BI e si dispone anche di Office 365, è possibile inviare domande utilizzando il collegamento Serve aiuto? dell'interfaccia di amministrazione di &quot; &quot; Microsoft [365.](https://portal.office.de/) Le opzioni di supporto per Dynamics 365 Customer Engagement sono disponibili [qui](/dynamics365/get-started/support/). Le opzioni di supporto per Power BI sono disponibili [qui](https://powerbi.microsoft.com/support/).
...
- I clienti che usano Skype for Business passano a Teams come parte della migrazione e potrebbero dover [scaricare e installare Teams](/deployoffice/teams-install) nei dispositivi.
...
- I clienti che eseguono il client di sincronizzazione di OneDrive devono disconnettersi dalla workstation e accedere di nuovo per consentire al client di sincronizzazione di OneDrive di accedere al servizio Globale di Azure Active Directory.
- Tenere presenti nuovi URL globali al termine della migrazione, in particolare Outlook Web Access (ad esempio: usare outlook.office365.com). I client di SharePoint Online continueranno a connettersi allo spazio dei nomi MCD utilizzando l'URL esistente (ad esempio: contoso.sharepoint.de).
...
### <a name="what-does-it-mean-to-ensure-network-connectivity-to-office-365-services-urls-and-ip-addresses"></a>Cosa significa garantire la connettività di rete agli URL e agli indirizzi IP dei servizi di [Office 365?](./urls-and-ip-address-ranges.md)
...
Tutti i clienti skype for business in verranno transizione a Microsoft Teams. La transizione delle zone DNS Skype dei clienti non è necessaria nella migrazione a Teams. I clienti potranno accedere a Teams immediatamente con tutte le funzionalità dopo la migrazione.
