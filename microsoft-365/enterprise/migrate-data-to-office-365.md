...
## <a name="ready-to-migrate-your-data-to-microsoft-365"></a>Sei pronto per eseguire la migrazione dei dati a Microsoft 365?

Le [istruzioni di configurazione di](https://support.office.com/article/Set-up-Office-365-for-business-6a3a29a0-e616-4713-99d1-15eda62d04fa) base consentono di ottenere tutti gli utenti che usano i servizi e le applicazioni di Microsoft 365 nel più breve tempo possibile. In questo modo vengono ignorati gli scenari ibridi e i metodi più avanzati per la migrazione a Microsoft 365. 
  
Se si desidera assistenza per la configurazione di Microsoft 365, [FastTrack](https://fasttrack.microsoft.com/office) è il modo più semplice per distribuire Microsoft 365, è anche possibile accedere e usare le guide alla configurazione per i servizi di [Microsoft 365.](setup-guides-for-microsoft-365.md)
...
- [Guide di orientamento alla configurazione ibrida di SharePoint Server.](https://docs.microsoft.com/SharePoint/hybrid/configuration-roadmaps) (Amministratore)
