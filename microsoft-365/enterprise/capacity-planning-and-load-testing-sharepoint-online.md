...
Anche se la crescita è spesso imprevedibile per qualsiasi tenant in una farm, la somma aggregata delle richieste è prevedibile nel tempo. Identificando le tendenze di crescita in SharePoint Online, è possibile pianificare l'espansione futura.
...
## <a name="why-you-cannot-load-test-sharepoint-online"></a>Motivo per cui non è possibile caricare sharePoint Online per il test
