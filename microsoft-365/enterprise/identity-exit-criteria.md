...
|||
|:-------|:-----|
|![](./media/deploy-foundation-infrastructure/win10enterprise_icon-small.png)| La fase successiva del processo di distribuzione end-to-end per Microsoft 365 Enterprise è [Windows 10 Enterprise](windows10-infrastructure.md). |
