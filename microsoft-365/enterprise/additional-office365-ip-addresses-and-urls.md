...
| 17   |  **FQDN di SharePoint Online e OneDrive for Business** <br> Tutti i nomi di dominio completo di ".sharepoint.com" con "\<tenant>" nel nome di dominio completo devono essere situati nell'area siti attendibili di Edge o IE del client per poter funzionare. Oltre all’intera famiglia di FQDN, CDN e telemetria elencata alla riga 14, è necessario aggiungere anche questi endpoint. |  | Siti attendibili |
...
[Monitorare la connettività di Microsoft 365](https://docs.microsoft.com/microsoft-365/enterprise/monitor-connectivity?view=o365-worldwide)
...
[Intervalli IP e tag di servizio di Azure - Cloud pubblico](https://www.microsoft.com/download/details.aspx?id=56519)

[Intervalli IP e tag di servizio di Azure - Cloud per il governo statunitense](https://www.microsoft.com/download/details.aspx?id=57063)

[Intervalli IP e tag di servizio di Azure - Cloud Germania](https://www.microsoft.com/download/details.aspx?id=57064)

[Intervalli IP e tag di servizio di Azure - China Cloud](https://www.microsoft.com/download/details.aspx?id=57062)
