...
Inoltre, poiché le build di Insider di Microsoft 365 Apps for enterprise riflettono gli aggiornamenti del canale mensili, se si utilizza il canale semestrale di Office per fornire aggiornamenti delle funzionalità due volte all'anno in linea con Windows, è possibile convalidare tali build in anticipo utilizzando anche le versioni del canale semestrale (mirato).
