...
È possibile integrare Microsoft 365 con Servizi di dominio Active Directory locale esistente e con le installazioni locali di Exchange Server, Skype for Business Server 2015 o SharePoint Server.
...
È inoltre possibile usare gli advisor di Azure Active Directory (Azure AD) per istruzioni di configurazione personalizzate nell'interfaccia di amministrazione di Microsoft 365 (è necessario accedere a Microsoft 365):
...
Per un elenco degli strumenti che è possibile utilizzare per gestire gli account utente di [Microsoft 365,](manage-microsoft-365-accounts.md) vedere manage Microsoft 365 accounts. 
...
Se si desidera che gli utenti possano accedere a Microsoft 365 con le proprie credenziali locali, è anche possibile configurare SSO. Con SSO, Microsoft 365 è configurato per considerare attendibile l'ambiente locale per l'autenticazione utente.
