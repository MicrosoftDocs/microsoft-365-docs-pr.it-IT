...
Esistono diversi motivi per evitare l'uso degli URL Office 365 e degli intervalli di indirizzi [IP](./urls-and-ip-address-ranges.md) per generare elenchi di filtri di prefissi. Includendo quanto segue:
  
- I Office 365 IP vengono spesso sottoposti a numerose modifiche.

- Gli OFFICE 365 e gli intervalli di indirizzi IP sono progettati per la gestione degli elenchi di indirizzi consentiti dal firewall e dell'infrastruttura proxy, non per il routing.

- Gli Office 365 e gli intervalli di indirizzi IP non coprono altri servizi Microsoft che potrebbero essere nell'ambito delle connessioni ExpressRoute.
...
|Restrizioni FQDN  <br/> |**Alto:** Il cliente limita l'accesso Office 365 in uscita in base agli FQDN pubblicati.  <br/> |Modifiche mensili.  <br/> |
...
- Posta da un Exchange Online tenant a un host locale.
...
Microsoft consiglia di accettare queste connessioni tramite il circuito Internet anziché il circuito ExpressRoute per ridurre la complessità. Se le esigenze di conformità o prestazioni determinano che queste connessioni in ingresso devono essere accettate su un circuito ExpressRoute, è consigliabile utilizzare un firewall o un proxy inverso per l'ambito delle connessioni accettate. Puoi usare gli [endpoint Office 365](./urls-and-ip-address-ranges.md) per capire i nomi FQDN e i prefissi IP.
  
### <a name="compliance"></a>Conformità

Microsoft non si basa sul percorso di instradamento utilizzato per nessuno dei controlli di conformità. Indipendentemente dal fatto che ci si connetta Office 365 servizi su un circuito ExpressRoute o Internet, i controlli di conformità non cambiano. È consigliabile esaminare i diversi livelli di certificazione di conformità e sicurezza Office 365 per trovare la scelta migliore per soddisfare le esigenze dell'organizzazione.
