...
Le [istruzioni di configurazione di](https://docs.microsoft.com/microsoft-365/admin/setup/setup) base consentono di ottenere tutti gli utenti che usano i servizi e le applicazioni di Microsoft 365 nel più breve tempo possibile. A volte è preferibile configurare gli elementi prima che tutti inizino a usarli. Ad esempio, se si desidera configurare il routing della posta, l'archiviazione dei file o i criteri di condivisione. 
