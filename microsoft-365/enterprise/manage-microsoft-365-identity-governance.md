...
---
# <a name="manage-microsoft-365-identity-governance"></a>Gestire la Microsoft 365 governance delle identità
...
Per altre informazioni, vedi questa panoramica della governance delle identità [per Azure Active Directory (Azure AD)](/azure/active-directory/governance/identity-governance-overview).
...
La gestione dei diritti di Azure AD consente di gestire in modo più efficiente l'accesso a gruppi, applicazioni e siti SharePoint per utenti interni ed esterni.
