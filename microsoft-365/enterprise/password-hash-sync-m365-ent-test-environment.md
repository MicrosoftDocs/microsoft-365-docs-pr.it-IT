...
In questo articolo viene descritto come aggiungere la sincronizzazione dell'hash delle password all'ambiente di testing di Microsoft 365, che determina questa configurazione:
...
Successivamente, aggiungere **il file testlab.< >** dominio pubblico alla sottoscrizione di valutazione o a pagamento di Microsoft 365 tramite il processo di registrazione del dominio. Ciò consiste nell'aggiungere ulteriori record DNS al **testlab.<*dominio pubblico.* >** Per ulteriori informazioni, vedere [Aggiungere un dominio a Microsoft 365.](../admin/setup/add-domain.md)
...
Innanzitutto, installare e configurare Azure AD Connect in APP1.
...
4. Nella pagina Microsoft Azure Active Directory Connect selezionare **Scarica** e quindi **Esegui.**
    
5. Nella pagina **Benvenuto in Azure AD Connect** seleziona **Accetto** e quindi seleziona **Continua.**
...
8. Nella pagina **Connetti a Servizi di** dominio Active Directory immettere **TESTLAB \\ User1** in **Nome utente,** immettere la password in **Password** e quindi selezionare **Avanti.**
...
14. In **Licenze prodotto** selezionare la posizione (se necessario), disabilitare la licenza di Office **365 E5** e quindi abilitare la licenza di Microsoft **365 E5.** 
