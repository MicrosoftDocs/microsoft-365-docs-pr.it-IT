...
---
# <a name="windows-7-to-windows-10-manual-upgrade-step-by-step-guide"></a>Guida introduttiva per l’aggiornamento da Windows 7 a Windows 10
...
> File estratti da una versione ISO per Windows 10 Enterprise 32 bit
...
> Schermata iniziale della configurazione di Windows 10

Una volta applicati gli aggiornamenti, l'installazione di Windows 10 passerà alla fase successiva, selezionare immagine. Qui è necessario selezionare la propria versione di Windows. In questo caso, poiché il PC è installato in Windows 7 Enterprise, selezionare Windows 10 Enterprise.

![](media/windows-7-to-windows-10-upgrade-media/windows-7-to-windows-10-upgrade-media-4.png)

> Schermata di selezione immagine a 32 bit di Windows 10 Enterprise
...
*Notifiche applicabili e condizioni di licenza per Windows 10*
...
*Configurazione di aggiornamenti per Windows 10*
...
*Opzione predefinita di aggiornamento della configurazione di Windows 10*

Se si seleziona "Cambia cosa mantenere", verranno visualizzate le opzioni seguenti:
...
*Opzioni per l'installazione di Windows 10*
...
*Stato di installazione di Windows 10*
...
*Windows 10 che chiede il motivo per cui si tornerà a Windows 7*
...
*Ripristino di Windows 10 assicurandosi di avere le credenziali di accesso dell'installazione precedente*
...
*Schermata finale di ripristino di Windows 10 prima di tornare in Windows 7*
