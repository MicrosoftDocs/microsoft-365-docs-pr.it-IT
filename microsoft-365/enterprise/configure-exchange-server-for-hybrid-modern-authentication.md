...
1. Aggiunta di URL del servizio Web locale come nomi dell'entità servizio **(SPN)** in Azure AD.
 ...
 **Nota** La tua versione di Office supporta Ma? Vedere [Funzionamento dell'autenticazione moderna per le app client di Office 2013 e Office 2016.](modern-auth-for-office-2013-and-2016.md)
...
1. Prima di tutto, connettersi ad AAD con [queste istruzioni.](connect-to-microsoft-365-powershell.md)
   ...
   **Nota** È necessario utilizzare _l'opzione Connect-MsolService_ di questa pagina per poter utilizzare il comando seguente.
