...
- [Procedura: Create a page layout in SharePoint 2013](/sharepoint/dev/general-development/how-to-create-a-page-layout-in-sharepoint)
...
Lo screenshot seguente mostra il resto delle immagini che vengono scaricate dopo che sono state visualizzate.
