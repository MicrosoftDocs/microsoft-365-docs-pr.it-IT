...
Tutte le misurazioni di test dei computer client includono le informazioni sulla subnet LAN, che sono correlate ai dettagli dell'ubicazione di Office immessi. Gli esempi di misura e le posizioni degli uffici devono iniziare a essere visualizzati 24 ore dopo che questi prerequisiti sono stati soddisfatti.
