...
## <a name="microsoft-365-for-business-subscription-lifecycle"></a>Microsoft 365 for business: ciclo di vita della sottoscrizione
...
- Se si annulla l'abbonamento mensile, verrà disabilitato immediatamente (alla data di cancellazione). Questo significa che gli utenti perderanno immediatamente l'accesso alle risorse di Microsoft 365 e solo gli amministratori avranno accesso ai dati per i prossimi 90 giorni.
...
In qualità di amministratore globale o di fatturazione, è possibile [riattivare l'abbonamento](reactivate-your-subscription.md) e continuare a usare Microsoft 365 con tutti i dati dei clienti intatti. Se si sceglie di non riattivare il prodotto, assicurarsi di [eseguire il backup dei dati](back-up-data-before-switching-plans.md).
...
Al termine del processo, non sarà possibile continuare a utilizzare Microsoft 365 gratuitamente. È possibile procedere in diversi modi:
...
- **Estendere il periodo di valutazione.** Serve più tempo per valutare Microsoft 365? In alcuni casi potrebbe essere consentito [estendere il periodo di valutazione](../extend-your-trial.md).

- **Annullare la versione di valutazione o lasciarla scadere.** Se si decide di non acquistare Microsoft 365, è possibile lasciare scadere o [annullare](cancel-your-subscription.md)la versione di valutazione. Assicurarsi di eseguire il backup dei dati che si vogliono conservare. Trascorso il periodo di tolleranza di 30 giorni, le informazioni dell'account di valutazione e i relativi dati vengono eliminati definitivamente.
