...
ms.locfileid: "50917547"
---
# <a name="upgrade-from-an-office-365-e4-subscription"></a>Eseguire l'aggiornamento da un abbonamento a Office 365 E4

Questo articolo illustra il processo di aggiornamento da office 365 E4 a un nuovo abbonamento. Per informazioni sulle opzioni disponibili per l'aggiornamento da Office 365 E4, vedere Informazioni importanti per i clienti di [Office 365 E4.](important-information-e4.md)

> [!IMPORTANT]
> Questo articolo si applica agli abbonamenti a Office 365 E4 acquistati direttamente da Microsoft solo tramite carta di credito o fattura. Se l'abbonamento è stato acquistato in un altro modo, ad esempio tramite un partner o tramite il Centro servizi per contratti multilicenza, contattare il rappresentante dell'account Microsoft o il partner per aggiornare i piani.
...
- **Pianificare i tempi di inattività amministrativi.** Gli amministratori non possono usare l'interfaccia di amministrazione di Microsoft 365 durante l'aggiornamento del piano. A seconda del numero di utenti disponibili, l'aggiornamento può richiedere da minuti a ore. È consigliabile pianificare l'aggiornamento quando non è necessario apportare aggiornamenti tramite l'interfaccia di amministrazione di Microsoft 365.
...
5. Nella pagina **Carrello** verificare che tutto sia corretto. Seleziona se pagare mensilmente o ogni anno e verifica il numero di licenze in **Quantità**.
    > [!NOTE]
    > Sono elencati anche eventuali abbonamenti a componenti aggiuntivi associati all'abbonamento a Office 365 E4, ad esempio Archiviazione file extra di Office 365. Tuttavia, se si dispone di sottoscrizioni di componenti aggiuntivi incluse nella sottoscrizione a cui si sta eseguendo l'aggiornamento, verranno rimuoverle.
...
Se non si dispone ancora di un nuovo abbonamento, è possibile acquistare un altro abbonamento a [Microsoft 365 per le aziende.](../try-or-buy-microsoft-365.md)
...
3. Verificare che il nuovo abbonamento sia visualizzato e che il numero di licenze sia uguale a quello di Office 365 E4.
...
È possibile utilizzare l'interfaccia di amministrazione di Microsoft 365 per riassegnare le licenze per un massimo di 20 utenti alla volta. Per informazioni su come, vedere [Spostare gli utenti in un abbonamento diverso.](move-users-different-subscription.md)

> [!TIP]
> Se sono presenti molti utenti, è possibile usare PowerShell di [Office 365](../../enterprise/assign-licenses-to-user-accounts-with-microsoft-365-powershell.md)per assegnare licenze utente in blocco.
