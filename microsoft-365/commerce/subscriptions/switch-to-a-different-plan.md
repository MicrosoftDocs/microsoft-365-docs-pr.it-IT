...
Quando l'azienda cambia o sono necessarie altre funzionalità, è possibile cambiare piano.  
...
- [Aggiornare la famiglia Microsoft 365 a un abbonamento aziendale](https://support.microsoft.com/office/9322ffb8-a35d-4407-8ebe-ed6ea0859b9f.aspx)
- [Chiamare il supporto tecnico Microsoft](../../admin/contact-support-for-business-products.md)

## <a name="use-the-switch-plans-button"></a>Usare il pulsante Cambia piano
...
3. Selezionare un piano per visualizzare il nuovo costo totale mensile. Assicurati di leggere le informazioni **chiave,** quindi seleziona **Avanti** per estrarre.
...
4. Se serve aiuto, scegliere **Avvia chat** nella pagina **Cassa**.
    ...
    Al termine dell'estrazione, Microsoft 365 impiega alcuni minuti per finalizzare l'opzione. È possibile iniziare subito a usare il nuovo abbonamento.

## <a name="the-switch-plans-button-isnt-there"></a>Il pulsante Cambia piano non è presente

Se il **pulsante Cambia** piano non è disponibile, puoi provare a cambiare piano [manualmente](switch-plans-manually.md) o a chiamare [il supporto.](../../admin/contact-support-for-business-products.md) Per ulteriori informazioni, vedere [Perché non è possibile cambiare piano?](why-can-t-i-switch-plans.md)
  
Può succedere per questi motivi:
  
- Si usano più piani di Microsoft 365. È possibile usare il pulsante **Cambia piano** solo se tutti gli utenti sono abbonati allo stesso piano.
...
Per confrontare i piani prima di passare, vedere la pagina di confronto dei [prodotti Microsoft 365 per le](https://go.microsoft.com/fwlink/p/?linkid=842056) aziende. Per le specifiche tecniche, vedere [Microsoft 365 Service Descriptions](/office365/servicedescriptions/office-365-service-descriptions-technet-library).
  
Se si desidera passare a un piano [](switch-plans-manually.md)con un numero minore di servizi, è possibile cambiare piano manualmente oppure chiamare il [supporto tecnico Microsoft](../../admin/contact-support-for-business-products.md) per assistenza.
 ...
 **Verifica dello stato no profit**: in genere sono necessari 30 giorni per completare il processo di verifica per il proprio stato no profit. Se sono stati più di 30 giorni, contattare il supporto.
