...
| [Comprendere la fattura](https://docs.microsoft.com/microsoft-store/billing-understand-your-invoice-msfb) | Informazioni sulle fatture per gli elementi acquistati con Microsoft Customer Agreement. |
...
| [Gestire i profili di fatturazione](https://docs.microsoft.com/microsoft-store/billing-profile) | Personalizzare la modalità di fatturazione per gli elementi diversi nella fattura.  |
| [Cronologia degli ordini](https://docs.microsoft.com/microsoft-store/manage-orders-microsoft-store-for-business) | Monitorare gli ordini commerciali. |
