...
## <a name="i-have-a-question-about-my-bill-how-can-i-get-help"></a>Ho una domanda sulla fattura. Come posso ottenere assistenza?
...
Per domande su Office 365 gestito da 21Vianet, [contattare il supporto per i prodotti per le aziende](../../admin/contact-support-for-business-products.md).
...
::: moniker range="o365-worldwide"
## <a name="can-i-get-a-copy-of-my-billing-statement-sent-via-email"></a>È possibile ottenere una copia dell'estratto conto di fatturazione inviato tramite posta elettronica?
...
Gli abbonamenti a versioni di valutazione o a pagamento possono essere annullati in due modi, online oppure contattando il supporto. Per ulteriori informazioni sul metodo che è possibile utilizzare, a seconda delle circostanze, vedere [annullare l'abbonamento](../subscriptions/cancel-your-subscription.md).
  
## <a name="how-do-i-see-my-current-order-balance"></a>Come si visualizza il saldo dell'ordine corrente?

Il totale visualizzato nella pagina Fatture corrisponde al saldo della fattura, ovvero il totale alla data della fattura. Per visualizzare il saldo dell'ordine corrente, visualizzare l'ordine o la fattura più recente. 
...
Vedere [View your Bill or get Fapiaos in Office 365 gestito da 21ViaNet](../../admin/services-in-china/view-your-bill-or-get-a-fapiao.md).
...
1. Nella pagina <a href="https://go.microsoft.com/fwlink/p/?linkid=848040" target="_blank">fatture</a> selezionare un intervallo di date delle fatture.
...
1. Nella pagina fatture selezionare un intervallo di date delle fatture.
  
2. Per stampare o salvare una copia PDF della fattura, selezionare **Scarica fattura PDF**e quindi stampare il file PDF.

Per ulteriori informazioni, vedere [View your Bill or get Fapiaos in Office 365 gestito da 21ViaNet](../../admin/services-in-china/view-your-bill-or-get-a-fapiao.md).
