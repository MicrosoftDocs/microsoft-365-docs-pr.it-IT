...
Eliminare tutti gli utenti ad eccezione di un amministratore globale. L'amministratore globale completa la procedura per chiudere l'account. Prima di poter eliminare la directory alla fine di questo processo, è necessario eliminare tutti gli altri utenti.
...
Se nell'organizzazione viene utilizzato Active Directory che esegue la sincronizzazione con Microsoft Azure Active Directory (Azure AD), eliminare l'account utente da Active Directory. Per istruzioni, vedere <a href="https://docs.microsoft.com/azure/active-directory/users-groups-roles/users-bulk-delete">eliminare in blocco gli utenti in Azure Active Directory</a>.
...
2. Nella scheda **prodotti** individuare un abbonamento attivo. Selezionare **Altre azioni** (tre puntini), quindi selezionare **Annulla l’abbonamento**.
...
3. Nella sezione **impostazioni di sottoscrizione e pagamento** della pagina Dettagli sottoscrizione selezionare **Elimina sottoscrizione**.
...
> [!NOTE]
> Se non si è in grado di eliminare immediatamente una sottoscrizione disabilitata, <a href="https://go.microsoft.com/fwlink/p/?linkid=518322" target="_blank">contattare il supporto tecnico</a>

## <a name="step-4-disable-multi-factor-authentication"></a>Passaggio 4: disabilitare l'autenticazione a più fattori

1. Accedere all'interfaccia di amministrazione con un account di amministratore globale. Per verificare i ruoli di cui si dispone, vedere [controllare i ruoli di amministratore nell'organizzazione](../admin/add-users/assign-admin-roles.md#check-admin-roles-in-your-organization).
2. Passare alla pagina **utenti**  >  <a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">attivi</a> .
3. Scegliere **l'autenticazione a più fattori**.
4. Nella pagina autenticazione a più fattori disabilitare tutti gli account tranne l'account di amministratore globale attualmente in uso.
