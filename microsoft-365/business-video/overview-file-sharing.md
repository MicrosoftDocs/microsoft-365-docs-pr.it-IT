...
È necessario condividere file con clienti, clienti, partner, fornitori e altre persone dell'azienda. Come si condividono i file in modo che tutti possano trovarli, aprirli e modificarli?

|![Condividere in modo sicuro](../media/securely-share-file.png)<br/>[Condividere un file con un utente esterno all'azienda](#share-a-file-with-someone-outside-of-your-company)|![Collaborare con un client](../media/share-and-collab-with-partner.png) <br/>[Condividere e collaborare con un cliente o un partner commerciale](#share-and-collaborate-with-a-client-or-business-partner) | ![Condividere all'interno dell'organizzazione](../media/share-inside-your-org.png) <br/>[Condividere all'interno dell'azienda](#share-inside-your-business) |
|--|--|--|
...
1. Creare il team.
1. Caricare i file.
1. Invitare i partner o i fornitori al team come utenti "guest" per concedere loro l'accesso.

Ulteriori informazioni su come condividere [file all'esterno dell'organizzazione con collegamenti](https://support.microsoft.com/office/7266f44e-3e06-4736-b9d3-0580c24bba34)sicuri.

## <a name="share-inside-your-business"></a>Condividere all'interno dell'azienda

Se si lavora con i file condivisi all'interno dell'azienda, è anche una buona idea configurare un team in Microsoft Teams. Condividi i file qui e tutti gli utenti dell'azienda possono trovarli e modificarli facilmente e sai che stai lavorando tutti nella stessa pagina.

1. Creare il team e invitarlo.
1. Caricare i file.

Altre informazioni [sull'archiviazione dei file aziendali e](https://support.microsoft.com/office/e4d98e10-3532-4eed-85d6-92728454e32b) [l'archiviazione dei file dei dipendenti.](https://support.microsoft.com/office/12dbe3e4-dbef-48f8-a90e-87f1bc607073)

## <a name="how-to-get-it-done"></a>Come farlo

Serve aiuto? Scopri come:

- [Inviare e ricevere allegati](https://support.microsoft.com/en-us/office/sending-and-receiving-attachments-d32cd5ad-c7c5-49df-814d-4c17a5d3beb0)
