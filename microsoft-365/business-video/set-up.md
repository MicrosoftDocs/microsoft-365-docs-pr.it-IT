...
3.  Nella pagina **Il dominio è l'identità aziendale,** immettere il nome di dominio per l'azienda e quindi selezionare **Usa questo dominio.** Se si utilizza un registrar comune come WordPress o GoDaddy, i record verranno aggiunti automaticamente in questa pagina.
...
13. Al termine dell'installazione, tornare all'interfaccia di amministrazione di Microsoft. Nell'interfaccia di amministrazione è possibile continuare a configurare funzionalità come i criteri di Windows 10, DLP e così via nella  **pagina Di**  installazione.
